...
6.  Push your changes. A GitHub link will be returned in the output of the [`git`]` `[`push`] command. Open this link in a browser to create the pull request.
    ...
    ![The GitHub checks are collapsed by default and can be accessed by clicking on \"Show All Checks\".](https://rocm.docs.amd.com/en/latest/_images/GitHubCheck-Highlight.png)

    ![The Read The Docs Build is accessed from the Details link in the Read The Docs check.](https://rocm.docs.amd.com/en/latest/_images/GitHub-ReadThe-Docs-Highlight.png)
