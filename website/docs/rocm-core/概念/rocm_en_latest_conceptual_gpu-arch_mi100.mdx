...
![Structure of a single GCD in the AMD Instinct MI100 GPU](https://rocm.docs.amd.com/en/latest/_images/image004.png)
...
![Structure of the AMD Instinct GPU (MI100 generation)](https://rocm.docs.amd.com/en/latest/_images/image005.png)
...
![Block diagram of an MI100 compute unit with detailed SIMD view of the AMD CDNA architecture](https://rocm.docs.amd.com/en/latest/_images/image006.png)
