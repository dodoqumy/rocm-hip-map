...
![Inception V3 train and loss graph](https://rocm.docs.amd.com/en/latest/_images/inception-v3.png)
...
11. Four entries are for each monitored metric during training and validation. Use these to plot the training and validation loss for comparison, as well as the training and validation accuracy:
    ...
    ![Training and validation loss](https://rocm.docs.amd.com/en/latest/_images/TextClassification-6.png)

    ![Training and validation accuracy](https://rocm.docs.amd.com/en/latest/_images/TextClassification-7.png)
