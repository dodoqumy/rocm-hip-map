...
keywords: ["AMD", "AMD官方", "Docker", "GPU", "GPU编程", "HPC", "Linux", "PyTorch", "ROCm", "TensorFlow", "Windows", "bilingual", "container", "performance", "中英对照", "人工智能", "优化", "双语", "安装", "官方文档"]
...
# Deep learning: Inception V3 with PyTorch[\#](#deep-learning-inception-v3-with-pytorch "Link to this heading")
...
## Deep learning training[\#](#deep-learning-training "Link to this heading")
...
## Training phases[\#](#training-phases "Link to this heading")
...
## Case studies[\#](#case-studies "Link to this heading")

The following sections contain case studies for the Inception V3 model.

### Inception V3 with PyTorch[\#](#inception-v3-with-pytorch "Link to this heading")
...
#### Evaluating a pre-trained model[\#](#evaluating-a-pre-trained-model "Link to this heading")
...
1.  Run the PyTorch ROCm-based Docker image or refer to the section [[Installing PyTorch]](https://rocm.docs.amd.com/projects/install-on-linux/en/latest/install/3rd-party/pytorch-install.html "(in ROCm installation on Linux v7.2.2)") for setting up a PyTorch environment on ROCm.
...
#### Training Inception V3[\#](#training-inception-v3 "Link to this heading")
...
1.  Run the PyTorch ROCm Docker image or refer to the section [[Installing PyTorch]](https://rocm.docs.amd.com/projects/install-on-linux/en/latest/install/3rd-party/pytorch-install.html "(in ROCm installation on Linux v7.2.2)") for setting up a PyTorch environment on ROCm.
...
![Inception V3 train and loss graph](https://rocm.docs.amd.com/en/latest/conceptual/_images/inception-v3.png)

### Custom model with CIFAR-10 on PyTorch[\#](#custom-model-with-cifar-10-on-pytorch "Link to this heading")
...
### Case study: TensorFlow with Fashion-MNIST[\#](#case-study-tensorflow-with-fashion-mnist "Link to this heading")
...
### Case study: TensorFlow with text classification[\#](#case-study-tensorflow-with-text-classification "Link to this heading")
...
11. Four entries are for each monitored metric during training and validation. Use these to plot the training and validation loss for comparison, as well as the training and validation accuracy:
    ...
    ![Training and validation loss](https://rocm.docs.amd.com/en/latest/conceptual/_images/TextClassification-6.png)

    ![Training and validation accuracy](https://rocm.docs.amd.com/en/latest/conceptual/_images/TextClassification-7.png)
...
(cmake-packages.html "previous page")

previous

Using CMake

(../reference/api-libraries.html "next page")
