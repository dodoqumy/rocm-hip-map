...
keywords: ["AMD", "AMD官方", "CDNA2", "Docker", "GPU", "GPU编程", "HPC", "Linux", "MI100", "MI250", "ROCm", "Windows", "bilingual", "container", "performance", "中英对照", "人工智能", "优化", "双语", "官方文档"]
...
# AMD Instinct™ MI250 microarchitecture[\#](#amd-instinct-mi250-microarchitecture "Link to this heading")
...
![Structure of a single GCD in the AMD Instinct MI250 GPU.](https://rocm.docs.amd.com/en/latest/conceptual/gpu-arch/_images/image001.png)
...
![Dual-GCD architecture of the AMD Instinct MI250 GPUs](https://rocm.docs.amd.com/en/latest/conceptual/gpu-arch/_images/image002.png)
...
![Block diagram of AMD Instinct MI250 GPUs with 3rd Generation AMD EPYC processor](https://rocm.docs.amd.com/en/latest/conceptual/gpu-arch/_images/image003.png)
...
(mi350-performance-counters.html "previous page")

previous

MI350 Series performance counters

(mi100.html "next page")
