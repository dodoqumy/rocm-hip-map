...
**最后更新：** 2026-05-01 06:50 CST
**当前分支：** `phase2.0-database`
**最新提交：** `17e9b25` — feat(2.0.0): Phase 2.0.0 数据库化 — SQLite + 迁移 56 篇
...
1. **🔴 Phase 2.1.1** — 爬虫基础（BaseCrawler + http_client + extractor + dedup）
2. **🔴 Phase 2.1.2** — 官方源爬虫（RocmDocs sitemap + RocmBlog）
3. **🟡 Phase 8.7** — 论文部署验证
4. **🟢 Phase 2.1.3** — GitHub GraphQL（issue 0→5000+）
