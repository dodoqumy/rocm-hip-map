...
source_url: "https://rocm.docs.amd.com/en/docs-6.2.0/how-to/llm-fine-tuning-optimization/overview.html"
source_type: official
source_org: amd
credibility: 5
lifecycle: latest
fetched_at: 2026-05-04T16:17:38.928681+00:00
content_hash: "c47307bc520b30cd"
---

# Conceptual overview of fine-tuning LLMs[#](#conceptual-overview-of-fine-tuning-llms)
...
## The challenge of fine-tuning models[#](#the-challenge-of-fine-tuning-models)
...
## Optimizations for model fine-tuning[#](#optimizations-for-model-fine-tuning)
...
the [weight update diagram](#fine-tuning-llms-concept-challenge). This is how LoRA saves on
computing resources.
...
Continue the walkthrough in [Fine-tuning and inference](fine-tuning-and-inference.html).
