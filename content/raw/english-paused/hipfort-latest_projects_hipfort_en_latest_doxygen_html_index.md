---
title: "HIPFORT API Reference: HIPFORT API Reference &#8212; hipfort 0.7.1 Documentation"
source_url: "https://rocm.docs.amd.com/projects/hipfort/en/latest/doxygen/html/index.html"
source_type: official
source_org: amd
credibility: 5
lifecycle: latest
fetched_at: 2026-05-01T09:29:09.806572+00:00
content_hash: "3a820ec1344b0cbc"
---
...
<html lang="en" data-content_root="../../" >
  ...
  <head>
    ...
    <title>HIPFORT API Reference: HIPFORT API Reference &#8212; hipfort 0.7.1 Documentation</title>
...
<link rel="preload" as="script" href="../../_static/scripts/pydata-sphinx-theme.js?digest=8878045cc6db502f8baf" />
    ...
    <link rel="next" title="Related Pages" href="pages.html" />
    <link rel="prev" title="hipFORT examples" href="../../tutorials/examples.html" />
...
<li class="toctree-l1 current active has-children"><a class="current reference internal" href="#">hipFORT API reference</a><details open="open"><summary><span class="toctree-toggle" role="presentation"><i class="fa-solid fa-chevron-down"></i></span></summary><ul>
...
<nav aria-label="Breadcrumb" class="d-print-none">
  <ul class="bd-breadcrumbs">
    ...
    <li class="breadcrumb-item active" aria-current="page"><span class="ellipsis">HIPFORT API Reference: HIPFORT API Reference</span></li>
  </ul>
</nav>
</div>
...
<div id="searchbox"></div>
  ...
  <section id="hipfort-api-reference">
<h1>HIPFORT API Reference<a class="headerlink" href="#hipfort-api-reference" title="Link to this heading">#</a></h1>
...
<title>HIPFORT API Reference: HIPFORT API Reference</title>
...
<div class="title">HIPFORT API Reference </div>  </div>
</div><!--header-->
<div class="contents">
<div class="textblock"><p><a class="anchor" id="mainpage"></a> This is the full HIPFORT API Reference. The API is organized into <a href="namespaces.html">modules</a> based on the wrapped API. </p>
</div></div><!-- PageDoc -->
</div><!-- contents -->
