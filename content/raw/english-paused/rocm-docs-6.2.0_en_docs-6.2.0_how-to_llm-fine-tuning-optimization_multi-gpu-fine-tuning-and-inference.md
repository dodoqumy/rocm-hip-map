...
source_url: "https://rocm.docs.amd.com/en/docs-6.2.0/how-to/llm-fine-tuning-optimization/multi-gpu-fine-tuning-and-inference.html"
source_type: official
source_org: amd
credibility: 5
lifecycle: latest
fetched_at: 2026-05-04T16:17:10.856811+00:00
content_hash: "2d581bfd405b418e"
---
...
[PyTorch installation guide](https://rocm.docs.amd.com/projects/install-on-linux/en/docs-6.2.0/install/3rd-party/pytorch-install.html). For consistent installation, it’s recommended to use official ROCm prebuilt Docker images with the framework pre-installed.In the Docker container, check the availability of ROCM-capable accelerators using the following command.
...
Read more about inference frameworks in [LLM inference frameworks](llm-inference-frameworks.html).
