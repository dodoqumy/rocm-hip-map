...
credibility: 5
lifecycle: latest
fetched_at: 2026-05-03T09:00:58.774034+00:00
content_hash: "6d876f1bd541370f"
---
...
[ROCProfiler](https://rocm.docs.amd.com/projects/rocprofiler/en/latest/index.html)documentation.ROCm Compute Profiler builds upon ROCProfiler but provides more guided analysis. For more information, see
...
[ROCProfiler](https://rocm.docs.amd.com/projects/rocprofiler/en/latest/index.html) is primarily a low-level API for accessing and extracting GPU hardware performance
...
utility also depends on the [ROCTracer and ROC-TX libraries](https://rocm.docs.amd.com/projects/roctracer/en/latest/index.html), giving it the
...
[ROCm Compute Profiler](https://rocm.docs.amd.com/projects/rocprofiler-compute/en/latest/index.html) is a system performance profiler for high-performance computing (HPC) and
...
[ROCm Systems Profiler](https://rocm.docs.amd.com/projects/rocprofiler-systems/en/latest/index.html) is a comprehensive profiling and tracing tool for parallel applications,
...
[hipBLASLt](https://rocm.docs.amd.com/projects/hipBLASLt/en/latest/index.html) has a backend assembly generator in
...
What does [PerfDb](https://rocm.docs.amd.com/projects/MIOpen/en/latest/conceptual/perfdb.html) look like?
...
See [Using the performance database](https://rocm.docs.amd.com/projects/MIOpen/en/latest/conceptual/perfdb.html) for more information.
...
What does [FindDb](https://rocm.docs.amd.com/projects/MIOpen/en/latest/conceptual/finddb.html) look like?
...
See [Using the find APIs and immediate mode](https://rocm.docs.amd.com/projects/MIOpen/en/latest/how-to/find-and-immediate.html) for more information.
...
[RCCL](https://rocm.docs.amd.com/projects/rccl/en/latest/index.html) is a stand-alone library of standard collective
...
[Performance guidelines](https://rocm.docs.amd.com/projects/HIP/en/latest/how-to/performance_guidelines.html) section of the
HIP documentation.
...
See [HIP’s performance guidelines](https://rocm.docs.amd.com/projects/HIP/en/latest/how-to/performance_guidelines.html) for
greater detail.
...
[ROCr Debug Agent documentation](https://rocm.docs.amd.com/projects/rocr_debug_agent/en/latest/index.html).
