...
source_url: "https://rocm.docs.amd.com/en/docs-6.4.0/how-to/rocm-for-ai/fine-tuning/fine-tuning-and-inference.html"
source_type: official
source_org: amd
credibility: 5
lifecycle: latest
fetched_at: 2026-05-04T16:16:43.612738+00:00
content_hash: "0fb36c495e74b9b4"
---
...
Fine-tuning using ROCm involves leveraging AMD’s GPU-accelerated [libraries](https://rocm.docs.amd.com/en/docs-6.4.0/reference/api-libraries.html) and
[tools](https://rocm.docs.amd.com/en/docs-6.4.0/reference/rocm-tools.html) to optimize and train deep learning models. ROCm provides a comprehensive
