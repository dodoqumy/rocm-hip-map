---
title: "hipSPARSELt storage format &#8212; hipSPARSELt 0.2.6 Documentation"
source_url: "https://rocm.docs.amd.com/projects/hipSPARSELt/en/latest/conceptual/storage-format.html"
source_type: official
source_org: amd
credibility: 5
lifecycle: latest
fetched_at: 2026-05-02T15:10:57.383099+00:00
content_hash: "4ca55092fc296a60"
---
...
<meta content="hipSPARSELt storage formats" name="description" />
<meta content="hipSPARSELt, ROCm, API library, API reference, storage formats" name="keywords" />

    <title>hipSPARSELt storage format &#8212; hipSPARSELt 0.2.6 Documentation</title>
...
<link rel="preload" as="script" href="../_static/scripts/pydata-sphinx-theme.js?digest=8878045cc6db502f8baf" />
    ...
    <script>DOCUMENTATION_OPTIONS.pagename = 'conceptual/storage-format';</script>
    <script async="async" src="https://download.amd.com/js/analytics/analyticsinit.js"></script>
    <link rel="icon" href="https://www.amd.com/content/dam/code/images/favicon/favicon.ico"/>
    <link rel="index" title="Index" href="../genindex.html" />
    <link rel="search" title="Search" href="../search.html" />
    <link rel="next" title="hipSPARSELt features for the Instinct MI300 series" href="mi300-features.html" />
    <link rel="prev" title="Installing and building hipSPARSELt" href="../install/install-hipsparselt.html" />
    <meta name="google-site-verification" content="vo35SZt_GASsTHAEmdww7AYKPCvZyzLvOXBl8guBME4" />

  <script async type="text/javascript" src="/_/static/javascript/readthedocs-addons.js"></script><meta name="readthedocs-project-slug" content="advanced-micro-devices-hipsparselt" /><meta name="readthedocs-version-slug" content="latest" /><meta name="readthedocs-resolver-filename" content="/conceptual/storage-format.html" /><meta name="readthedocs-http-status" content="200" /></head>
...
<li class="toctree-l1 current active"><a class="current reference internal" href="#">Storage formats</a></li>
<li class="toctree-l1"><a class="reference internal" href="mi300-features.html">Features for the Instinct MI300 series</a></li>
</ul>
...
<nav aria-label="Breadcrumb" class="d-print-none">
  <ul class="bd-breadcrumbs">
    ...
    <li class="breadcrumb-item active" aria-current="page"><span class="ellipsis">hipSPARSELt storage format</span></li>
  </ul>
</nav>
</div>
...
<div id="jb-print-docs-body" class="onlyprint">
    <h1>hipSPARSELt storage format</h1>
    <!-- Table of contents -->
...
<div id="searchbox"></div>
  ...
  <section id="hipsparselt-storage-format">
<span id="storage-format"></span><h1>hipSPARSELt storage format<a class="headerlink" href="#hipsparselt-storage-format" title="Link to this heading">#</a></h1>
<p>hipSPARSELt uses a structured sparsity storage format, which is represented by an
<span class="math notranslate nohighlight">\(m \times n\)</span> matrix, where:</p>
<ul class="simple">
<li><p><strong>m</strong> = number of rows (integer)</p></li>
<li><p><strong>n</strong> = number of columns (integer)</p></li>
<li><p><strong>sparsity</strong> = 50%, the ratio of <code class="docutils literal notranslate"><span class="pre">nnz</span></code> elements in every 2:1 (int) or 4:2 (others) element along the row
(4:2 means every 4 continuous elements only has 2 <code class="docutils literal notranslate"><span class="pre">nnz</span></code> elements)</p></li>
<li><p><strong>compressed matrix</strong> = matrix of <code class="docutils literal notranslate"><span class="pre">nnz</span></code> elements containing data</p></li>
<li><p><strong>metadata</strong> = matrix of <code class="docutils literal notranslate"><span class="pre">nnz</span></code> elements containing the element indices in every 4:2 or 2:1 array
along the row (the contents or structure of the metadata is dependent on the chosen solution by the backend
implementation)</p></li>
</ul>
<p>Consider the following <span class="math notranslate nohighlight">\(4 \times 4\)</span> matrix and the structured sparsity structures using
<span class="math notranslate nohighlight">\(m = 4, n = 4\)</span>:</p>
...
<p>where</p>
<div class="math notranslate nohighlight">
\[\begin{split}Compressed A = \begin{pmatrix}
                1.0 &amp; 2.0 \\
                3.0 &amp; 4.0 \\
                6.0 &amp; 7.0 \\
                6.0 &amp; 8.0 \\
...
<div class="prev-next-area">
    <a class="left-prev"
       href="../install/install-hipsparselt.html"
       title="previous page">
