---
title: "Terminology Reference - Key Concepts and Definitions &#8212; Composable Kernel 1.2.0 Documentation"
source_url: "https://rocm.docs.amd.com/projects/composable_kernel/en/latest/conceptual/ck_tile/terminology.html"
source_type: official
source_org: amd
credibility: 5
lifecycle: latest
fetched_at: 2026-05-02T21:09:51.756084+00:00
content_hash: "c86e56c550ccc41c"
---

# Terminology Reference - Key Concepts and Definitions[#](#terminology-reference-key-concepts-and-definitions)
...
For a comprehensive mathematical treatment of coordinate systems, see [Coordinate Systems - The Mathematical Foundation](coordinate_systems.html#ck-tile-coordinate-systems).

### P-Space (Partition Space)[#](#p-space-partition-space)
...
### Y-Space (Yield Space)[#](#y-space-yield-space)
...
### X-Space (Physical Tensor Space)[#](#x-space-physical-tensor-space)
...
### R-Space (Replication Space)[#](#r-space-replication-space)
...
### D-Space (Data Space)[#](#d-space-data-space)
...
### H-Dimensions (Hierarchical Dimensions)[#](#h-dimensions-hierarchical-dimensions)
...
### RH-Dimensions (R + H Dimensions Combined)[#](#rh-dimensions-r-h-dimensions-combined)
...
A performance degradation that occurs when multiple threads in a warp access different addresses in the same memory bank. For detailed information about bank conflicts and mitigation strategies, see [Understanding AMD GPU LDS and Bank Conflicts](hardware/lds_bank_conflicts.html#ck-tile-lds-bank-conflicts).
...
A view into a subset of a tensor that respects the distribution pattern. For detailed information about tile windows and their usage, see [Tile Window - Data Access Gateway](tile_window.html#ck-tile-tile-window).

**C++ Type**: `tile_window<...>`


### Static Distributed Tensor[#](#static-distributed-tensor)

A thread-local tensor stored in registers, distributed according to a tile distribution. For in-depth coverage of static distributed tensors, see [Static Distributed Tensor](static_distributed_tensor.html#ck-tile-static-distributed-tensor).
...
## GPU Hardware Terms[#](#gpu-hardware-terms)
...
## Optimization Terms[#](#optimization-terms)
...
A fundamental operation where C = αA×B + βC. For a complete optimization case study, see [A Block GEMM on MI300](hardware/gemm_optimization.html#ck-tile-gemm-optimization).
...
### Using Tile Window[#](#using-tile-window)
