...
credibility: 5
lifecycle: latest
fetched_at: 2026-05-02T18:01:23.768474+00:00
content_hash: "415ea128d3af80f5"
---
...
[ROCm PyTorch installation guide](https://rocm.docs.amd.com/projects/install-on-linux/en/latest/install/3rd-party/pytorch-install.html)for installation and setup instructions.You can also consult the upstream
...
modifications. For more information, see [HIPIFY](https://rocm.docs.amd.com/projects/HIPIFY/en/latest/index.html).
...
documentation](https://rocm.docs.amd.com/projects/install-on-linux/en/latest/install/3rd-party/pytorch-install.html#pytorch-docker-support) for a list of
...
See [ROCm precision support](https://rocm.docs.amd.com/en/latest/reference/precision-support.html) for the
...
## Key features and enhancements for PyTorch 2.9 with ROCm 7.2.1[#](#key-features-and-enhancements-for-pytorch-2-9-with-rocm-7-2-1)
