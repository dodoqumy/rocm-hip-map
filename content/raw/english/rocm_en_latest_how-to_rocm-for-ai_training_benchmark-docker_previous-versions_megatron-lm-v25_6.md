...
source_url: "https://rocm.docs.amd.com/en/latest/how-to/rocm-for-ai/training/benchmark-docker/previous-versions/megatron-lm-v25.6.html"
...
::::::: {.sd-tab-set .docutils}
[`rocm/megatron-lm:v25.6_py312`{.docutils .literal .notranslate}]{.pre}
...
[`rocm/megatron-lm:v25.6_py310`{.docutils .literal .notranslate}]{.pre}
...
::::::::::::::: {.row .col-10}
::: {.col-4 .model-param param-group="llama" param-k="model" param-v="pyt_megatron_lm_train_llama-3.3-70b" tabindex="0"}
Llama 3.3 70B
:::

::: {.col-4 .model-param param-group="llama" param-k="model" param-v="pyt_megatron_lm_train_llama-3.1-8b" tabindex="0"}
Llama 3.1 8B
:::

::: {.col-4 .model-param param-group="llama" param-k="model" param-v="pyt_megatron_lm_train_llama-3.1-70b" tabindex="0"}
Llama 3.1 70B
:::

::: {.col-4 .model-param param-group="llama" param-k="model" param-v="pyt_megatron_lm_train_llama-3.1-70b-proxy" tabindex="0"}
Llama 3.1 70B (proxy)
:::

::: {.col-4 .model-param param-group="llama" param-k="model" param-v="pyt_megatron_lm_train_llama-2-7b" tabindex="0"}
Llama 2 7B
:::

::: {.col-4 .model-param param-group="llama" param-k="model" param-v="pyt_megatron_lm_train_llama-2-70b" tabindex="0"}
Llama 2 70B
:::

::: {.col-6 .model-param param-group="deepseek" param-k="model" param-v="pyt_megatron_lm_train_deepseek-v3-proxy" tabindex="0"}
DeepSeek-V3 (proxy)
:::

::: {.col-6 .model-param param-group="deepseek" param-k="model" param-v="pyt_megatron_lm_train_deepseek-v2-lite-16b" tabindex="0"}
DeepSeek-V2-Lite
:::

::: {.col-6 .model-param param-group="mistral" param-k="model" param-v="pyt_megatron_lm_train_mixtral-8x7b" tabindex="0"}
Mixtral 8x7B
:::

::: {.col-6 .model-param param-group="mistral" param-k="model" param-v="pyt_megatron_lm_train_mixtral-8x22b-proxy" tabindex="0"}
Mixtral 8x22B (proxy)
:::

::: {.col-6 .model-param param-group="qwen" param-k="model" param-v="pyt_megatron_lm_train_qwen2.5-7b" tabindex="0"}
Qwen 2.5 7B
:::

::: {.col-6 .model-param param-group="qwen" param-k="model" param-v="pyt_megatron_lm_train_qwen2.5-72b" tabindex="0"}
Qwen 2.5 72B
:::
:::::::::::::::
:::::::::::::::::
...
[]{#amd-megatron-lm-performance-measurements-v256}
...
[]{#mi300x-amd-megatron-lm-training-v256}
...
[]{#amd-megatron-lm-requirements-v256}
...
1.  Use the following command to pull the Docker image from Docker Hub.
    ...
    :::: {.highlight-shell .notranslate}
    ::: highlight
        docker pull rocm/megatron-lm:v25.6_py310
    :::
    ::::
    :::::
    :::::::::
...
The Docker container includes a pre-installed, verified version of the ROCm Megatron-LM development branch [ROCm/Megatron-LM](https://github.com/ROCm/Megatron-LM/tree/rocm_dev){.github .reference .external}, including necessary training scripts.
:::
::::

::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: {#configuration .section}
[]{#amd-megatron-lm-environment-setup-v256}
...
Update the [`train_llama3.sh`{.docutils .literal .notranslate}]{.pre} configuration script in the [`examples/llama`{.docutils .literal .notranslate}]{.pre} directory of [ROCm/Megatron-LM](https://github.com/ROCm/Megatron-LM/tree/rocm_dev/examples/llama){.github .reference .external} to configure your training run. Options can also be passed as command line arguments as described in [[Run training]{.std .std-ref}](#amd-megatron-lm-run-training-v256){.reference .internal}.
:::

::: {.model-doc .pyt-megatron-lm-train-llama-2-7b .pyt-megatron-lm-train-llama-2-70b .docutils .container}
Update the [`train_llama2.sh`{.docutils .literal .notranslate}]{.pre} configuration script in the [`examples/llama`{.docutils .literal .notranslate}]{.pre} directory of [ROCm/Megatron-LM](https://github.com/ROCm/Megatron-LM/tree/rocm_dev/examples/llama){.github .reference .external} to configure your training run. Options can also be passed as command line arguments as described in [[Run training]{.std .std-ref}](#amd-megatron-lm-run-training-v256){.reference .internal}.
:::

::: {.model-doc .pyt-megatron-lm-train-deepseek-v3-proxy .docutils .container}
Update the [`train_deepseekv3.sh`{.docutils .literal .notranslate}]{.pre} configuration script in the [`examples/deepseek_v3`{.docutils .literal .notranslate}]{.pre} directory of [ROCm/Megatron-LM](https://github.com/ROCm/Megatron-LM/tree/rocm_dev/examples/deepseek_v3){.github .reference .external} to configure your training run. Options can also be passed as command line arguments as described in [[Run training]{.std .std-ref}](#amd-megatron-lm-run-training-v256){.reference .internal}.
:::

::: {.model-doc .pyt-megatron-lm-train-deepseek-v2-lite-16b .docutils .container}
Update the [`train_deepseekv2.sh`{.docutils .literal .notranslate}]{.pre} configuration script in the [`examples/deepseek_v2`{.docutils .literal .notranslate}]{.pre} directory of [ROCm/Megatron-LM](https://github.com/ROCm/Megatron-LM/tree/rocm_dev/examples/deepseek_v2){.github .reference .external} to configure your training run. Options can also be passed as command line arguments as described in [[Run training]{.std .std-ref}](#amd-megatron-lm-run-training-v256){.reference .internal}.
:::

::: {.model-doc .pyt-megatron-lm-train-mixtral-8x7b .pyt-megatron-lm-train-mixtral-8x22b-proxy .docutils .container}
Update the [`train_mixtral_moe.sh`{.docutils .literal .notranslate}]{.pre} configuration script in the [`examples/mixtral`{.docutils .literal .notranslate}]{.pre} directory of [ROCm/Megatron-LM](https://github.com/ROCm/Megatron-LM/tree/rocm_dev/examples/mixtral){.github .reference .external} to configure your training run. Options can also be passed as command line arguments as described in [[Run training]{.std .std-ref}](#amd-megatron-lm-run-training-v256){.reference .internal}.
:::

::: {.admonition .note}
Note

See [[Key options]{.std .std-ref}](#amd-megatron-lm-benchmark-test-vars-v256){.reference .internal} for more information on configuration options.
:::
...
:::::::::::::::::::::::::::::::: {#tokenizer .section}
[]{#amd-megatron-lm-tokenizer-v256}
...
[`TOKENIZER_MODEL`{.docutils .literal .notranslate}]{.pre} can be any accessible Hugging Face tokenizer. Remember to either pre-download the tokenizer or setup Hugging Face access otherwise when needed -- see the [[Tokenizer]{.std .std-ref}](#amd-megatron-lm-tokenizer-v256){.reference .internal} section.
...
[]{#amd-megatron-lm-run-training-v256}

## Run training[\#](#run-training "Link to this heading"){.headerlink}

Use the following example commands to set up the environment, configure [[key options]{.std .std-ref}](#amd-megatron-lm-benchmark-test-vars-v256){.reference .internal}, and run training on MI300X Series GPUs with the AMD Megatron-LM environment.
...
::: {#key-options .section}
[]{#amd-megatron-lm-benchmark-test-vars-v256}
