...
source_url: "https://rocm.docs.amd.com/en/latest/how-to/rocm-for-ai/inference/benchmark-docker/previous-versions/vllm-0.6.4.html"
...
- [ROCm 6.2.1](https://github.com/ROCm/ROCm){.reference .external}

- [vLLM 0.6.4](https://docs.vllm.ai/en/latest){.reference .external}

- [PyTorch 2.5.0](https://github.com/pytorch/pytorch){.reference .external}
...
+-----------------+------------------+----------------+-----------------+-------------+------------+
| - Llama 3.1 8B  | - Llama 3.1 405B | - Llama 2 70B  | - Mixtral 8x22B | - Qwen2 7B  | - JAIS 13B |
|                 |                  |                |                 |             |            |
| - Llama 3.1 70B | - Llama 2 7B     | - Mixtral 8x7B | - Mixtral 7B    | - Qwen2 72B | - JAIS 30B |
+-----------------+------------------+----------------+-----------------+-------------+------------+
...
- [[MAD-integrated benchmarking]{.std .std-ref}](#vllm-benchmark-mad-v064){.reference .internal}

- [[Standalone benchmarking]{.std .std-ref}](#vllm-benchmark-standalone-v064){.reference .internal}
:::

:::::::: {#mad-integrated-benchmarking .section}
[]{#vllm-benchmark-mad-v064}
...
Although the following models are preconfigured to collect latency and throughput performance data, you can also change the benchmarking parameters. Refer to the [[Standalone benchmarking]{.std .std-ref}](#vllm-benchmark-standalone-v064){.reference .internal} section.

::: {#available-models .section}
### Available models[\#](#available-models "Link to this heading"){.headerlink}

+----------------------------------------------------------------------+---------------------------------------------------------------------+--------------------------------------------------------------------------+
| - [`pyt_vllm_llama-3.1-8b`{.docutils .literal .notranslate}]{.pre}   | - [`pyt_vllm_mixtral-8x22b`{.docutils .literal .notranslate}]{.pre} | - [`pyt_vllm_llama-3.1-8b_fp8`{.docutils .literal .notranslate}]{.pre}   |
|                                                                      |                                                                     |                                                                          |
| - [`pyt_vllm_llama-3.1-70b`{.docutils .literal .notranslate}]{.pre}  | - [`pyt_vllm_mistral-7b`{.docutils .literal .notranslate}]{.pre}    | - [`pyt_vllm_llama-3.1-70b_fp8`{.docutils .literal .notranslate}]{.pre}  |
|                                                                      |                                                                     |                                                                          |
| - [`pyt_vllm_llama-3.1-405b`{.docutils .literal .notranslate}]{.pre} | - [`pyt_vllm_qwen2-7b`{.docutils .literal .notranslate}]{.pre}      | - [`pyt_vllm_llama-3.1-405b_fp8`{.docutils .literal .notranslate}]{.pre} |
|                                                                      |                                                                     |                                                                          |
| - [`pyt_vllm_llama-2-7b`{.docutils .literal .notranslate}]{.pre}     | - [`pyt_vllm_qwen2-72b`{.docutils .literal .notranslate}]{.pre}     | - [`pyt_vllm_mixtral-8x7b_fp8`{.docutils .literal .notranslate}]{.pre}   |
|                                                                      |                                                                     |                                                                          |
| - [`pyt_vllm_llama-2-70b`{.docutils .literal .notranslate}]{.pre}    | - [`pyt_vllm_jais-13b`{.docutils .literal .notranslate}]{.pre}      | - [`pyt_vllm_mixtral-8x22b_fp8`{.docutils .literal .notranslate}]{.pre}  |
|                                                                      |                                                                     |                                                                          |
| - [`pyt_vllm_mixtral-8x7b`{.docutils .literal .notranslate}]{.pre}   | - [`pyt_vllm_jais-30b`{.docutils .literal .notranslate}]{.pre}      |                                                                          |
+----------------------------------------------------------------------+---------------------------------------------------------------------+--------------------------------------------------------------------------+
:::
::::::::

:::::::::::::::::::::::: {#standalone-benchmarking .section}
[]{#vllm-benchmark-standalone-v064}
...
To start the benchmark, use the following command with the appropriate options. See [[Options]{.std .std-ref}](#vllm-benchmark-standalone-v064-options){.reference .internal} for the list of options and their descriptions.
...
See the [[examples]{.std .std-ref}](#vllm-benchmark-run-benchmark-v064){.reference .internal} for more information.
...
:::: {#options .section}
[]{#vllm-benchmark-standalone-v064-options}
...
::: pst-scrollable-table-container
  ...
  ([`float16`{.docutils .literal .notranslate}]{.pre})      [`meta-llama/Meta-Llama-3.1-70B-Instruct`{.docutils .literal .notranslate}]{.pre}                         Llama 3.1 70B
                                                            ...
                                                            [`meta-llama/Llama-2-70b-chat-hf`{.docutils .literal .notranslate}]{.pre}                                 Llama 2 70B
                                                            ...
                                                            [`Qwen/Qwen2-72B-Instruct`{.docutils .literal .notranslate}]{.pre}                                        Qwen2 72B
  ...
  [`$model_repo`{.docutils .literal .notranslate}]{.pre}    [`amd/Meta-Llama-3.1-8B-Instruct-FP8-KV`{.docutils .literal .notranslate}]{.pre}                          Llama 3.1 8B
  ([`float8`{.docutils .literal .notranslate}]{.pre})       [`amd/Meta-Llama-3.1-70B-Instruct-FP8-KV`{.docutils .literal .notranslate}]{.pre}                         Llama 3.1 70B
                                                            [`amd/Meta-Llama-3.1-405B-Instruct-FP8-KV`{.docutils .literal .notranslate}]{.pre}                        Llama 3.1 405B
                                                            [`amd/Mixtral-8x7B-Instruct-v0.1-FP8-KV`{.docutils .literal .notranslate}]{.pre}                          Mixtral 8x7B
                                                            [`amd/Mixtral-8x22B-Instruct-v0.1-FP8-KV`{.docutils .literal .notranslate}]{.pre}                         Mixtral 8x22B
...
[]{#vllm-benchmark-run-benchmark-v064}

### Running the benchmark on the MI300X GPU[\#](#running-the-benchmark-on-the-mi300x-gpu "Link to this heading"){.headerlink}

Here are some examples of running the benchmark with various options. See [[Options]{.std .std-ref}](#vllm-benchmark-standalone-v064-options){.reference .internal} for the list of options and their descriptions.
...
Use this command to benchmark the latency of the Llama 3.1 8B model on one GPU with the [`float16`{.docutils .literal .notranslate}]{.pre} and [`float8`{.docutils .literal .notranslate}]{.pre} data types.
...
- [`./reports_float8/summary/Meta-Llama-3.1-8B-Instruct-FP8-KV_latency_report.csv`{.docutils .literal .notranslate}]{.pre}
:::::
...
- [`./reports_float8/summary/Meta-Llama-3.1-8B-Instruct-FP8-KV_throughput_report.csv`{.docutils .literal .notranslate}]{.pre}
