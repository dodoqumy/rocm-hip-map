...
credibility: 5
lifecycle: latest
fetched_at: 2026-05-01T08:04:58.905559+00:00
content_hash: "ee037d1c68c54922"
---
...
See [Supported models](#amd-pytorch-training-model-support-v259) to switch to another available model.
...
pull rocm/pytorch-training:v25.9_gfx950

pull rocm/pytorch-training:v25.9_gfx942

Launch the Docker container.

run -it \ --device /dev/dri \ --device /dev/kfd \ --network host \ --ipc host \ --group-add video \ --cap-add SYS_PTRACE \ --security-opt seccomp=unconfined \ --privileged \ -v $HOME:$HOME \ -v $HOME/.ssh:/root/.ssh \ --shm-size 64G \ --name training_env \ rocm/pytorch-training:v25.9_gfx950

run -it \ --device /dev/dri \ --device /dev/kfd \ --network host \ --ipc host \ --group-add video \ --cap-add SYS_PTRACE \ --security-opt seccomp=unconfined \ --privileged \ -v $HOME:$HOME \ -v $HOME/.ssh:/root/.ssh \ --shm-size 64G \ --name training_env \ rocm/pytorch-training:v25.9_gfx942
...
See [supported training modes](#amd-pytorch-training-supported-training-modes-v259).
