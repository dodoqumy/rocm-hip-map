...
credibility: 5
lifecycle: latest
fetched_at: 2026-05-03T06:16:37.279745+00:00
content_hash: "ffb6ee8a06676ddd"
---
...
only reflects the [latest version of this training benchmarking environment](../megatron-lm.html).
...
To train any of the Llama 2 models that [this Docker image supports](#amd-megatron-lm-model-support-25-4), use the `Llama2Tokenizer`
...
in the [configuration script](#amd-megatron-lm-environment-setup-v254).
