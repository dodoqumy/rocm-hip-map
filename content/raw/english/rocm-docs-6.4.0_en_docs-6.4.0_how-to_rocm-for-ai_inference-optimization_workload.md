...
source_url: "https://rocm.docs.amd.com/en/docs-6.4.0/how-to/rocm-for-ai/inference-optimization/workload.html"
source_type: official
source_org: amd
credibility: 5
lifecycle: latest
fetched_at: 2026-05-04T15:21:48.013052+00:00
content_hash: "a95be8aa797742a1"
---
...
format. For more information, see [vLLM inference performance testing](../inference/vllm-benchmark.html).
...
[ROCProfiler](https://rocm.docs.amd.com/projects/rocprofiler/en/docs-6.4.0/index.html)documentation.ROCm Compute Profiler builds upon ROCProfiler but provides more guided analysis. For more information, see

[ROCm Compute Profiler documentation](https://rocm.docs.amd.com/projects/rocprofiler-compute/en/docs-6.4.0/index.html).
...
[ROCProfiler](https://rocm.docs.amd.com/projects/rocprofiler/en/docs-6.4.0/index.html) is primarily a low-level API for accessing and extracting GPU hardware performance
...
utility also depends on the [ROCTracer and ROC-TX libraries](https://rocm.docs.amd.com/projects/roctracer/en/docs-6.4.0/index.html), giving it the
...
[ROCm Compute Profiler](https://rocm.docs.amd.com/projects/rocprofiler-compute/en/docs-6.4.0/index.html) is a system performance profiler for high-performance computing (HPC) and
...
[ROCm Systems Profiler](https://rocm.docs.amd.com/projects/rocprofiler-systems/en/docs-6.4.0/index.html) is a comprehensive profiling and tracing tool for parallel applications,
...
As described in mi300x-env-vars, the environment variable
...
see [vLLM inference performance testing](../inference/vllm-benchmark.html).
...
[hipBLASLt](https://rocm.docs.amd.com/projects/hipBLASLt/en/docs-6.4.0/index.html) has a backend assembly generator in
...
What does [PerfDb](https://rocm.docs.amd.com/projects/MIOpen/en/docs-6.4.0/conceptual/perfdb.html) look like?
...
See [Using the performance database](https://rocm.docs.amd.com/projects/MIOpen/en/docs-6.4.0/conceptual/perfdb.html) for more information.
...
What does [FindDb](https://rocm.docs.amd.com/projects/MIOpen/en/docs-6.4.0/conceptual/finddb.html) look like?
...
See [Using the find APIs and immediate mode](https://rocm.docs.amd.com/projects/MIOpen/en/docs-6.4.0/how-to/find-and-immediate.html) for more information.
...
[RCCL](https://rocm.docs.amd.com/projects/rccl/en/docs-6.4.0/index.html) is a stand-alone library of standard collective
...
. For more
details, see AMD Instinct MI300X system optimization.
...
[Performance guidelines](https://rocm.docs.amd.com/projects/HIP/en/docs-6.4.0/how-to/performance_guidelines.html) section of the
HIP documentation.
...
See [HIP’s performance guidelines](https://rocm.docs.amd.com/projects/HIP/en/docs-6.4.0/how-to/performance_guidelines.html) for
greater detail.
...
[ROCr Debug Agent documentation](https://rocm.docs.amd.com/projects/rocr_debug_agent/en/docs-6.4.0/index.html).
