---
title: "ROCm OpenMP support &#8212; llvm-project 22.0.0 Documentation"
source_url: "https://rocm.docs.amd.com/projects/llvm-project/en/latest/conceptual/openmp.html"
source_type: official
source_org: amd
credibility: 5
lifecycle: latest
fetched_at: 2026-05-03T06:27:36.946065+00:00
content_hash: "792d755592d19fe6"
---

# ROCm OpenMP support[#](#rocm-openmp-support)
...
this ROCm release. See the list of supported GPUs for [Linux](https://rocm.docs.amd.com/projects/install-on-linux/en/latest/reference/system-requirements.html) and
...
|
To ensure data copy operations between the host and device occur regardless of the |
|
...
### Using AddressSanitizer tool with OpenMP applications[#](#using-addresssanitizer-tool-with-openmp-applications)
...
## OpenMP release updates[#](#openmp-release-updates)
