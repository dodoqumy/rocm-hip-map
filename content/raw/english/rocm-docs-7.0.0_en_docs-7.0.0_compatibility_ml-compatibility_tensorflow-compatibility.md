...
source_url: "https://rocm.docs.amd.com/en/docs-7.0.0/compatibility/ml-compatibility/tensorflow-compatibility.html"
source_type: official
source_org: amd
credibility: 5
lifecycle: latest
fetched_at: 2026-05-02T15:03:48.069852+00:00
content_hash: "d3196a8c365a0823"
---
...
[Docker images](#tensorflow-docker-compat)with ROCm and TensorFlow pre-installed.ROCm TensorFlow repository:

[ROCm/tensorflow-upstream](https://github.com/ROCm/tensorflow-upstream)See the

[ROCm TensorFlow installation guide](https://rocm.docs.amd.com/projects/install-on-linux/en/docs-7.0.0/install/3rd-party/tensorflow-install.html)to get started.

Official TensorFlow release:

Official TensorFlow repository:

[tensorflow/tensorflow](https://github.com/tensorflow/tensorflow)See the

[TensorFlow API versions](https://www.tensorflow.org/versions)list.
...
documentation](https://rocm.docs.amd.com/projects/install-on-linux/en/docs-7.0.0/install/3rd-party/tensorflow-install.html#tensorflow-docker-support) for a list of
