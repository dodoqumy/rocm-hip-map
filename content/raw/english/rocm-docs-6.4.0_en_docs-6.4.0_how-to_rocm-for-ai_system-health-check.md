...
source_url: "https://rocm.docs.amd.com/en/docs-6.4.0/how-to/rocm-for-ai/system-health-check.html"
source_type: official
source_org: amd
credibility: 5
lifecycle: latest
fetched_at: 2026-05-04T16:07:18.492877+00:00
content_hash: "2599e6dab0e5ec69"
---

# System health benchmarks[#](#system-health-benchmarks)
...
and [System validation tests](https://instinct.docs.amd.com/projects/system-acceptance/en/latest/mi300x/system-validation.html#system-validation-tests)
...
Run the benchmark, stress, and qualification tests included with RVS. See the [Benchmark, stress, qualification](https://instinct.docs.amd.com/projects/system-acceptance/en/latest/mi300x/system-validation.html#benchmark-stress-qualification)
...
For more information, see [Performance benchmarking](https://instinct.docs.amd.com/projects/system-acceptance/en/latest/mi300x/performance-bench.html#babelstream-benchmarking-results)
...
[RCCL benchmarking](https://instinct.docs.amd.com/projects/system-acceptance/en/latest/mi300x/performance-bench.html#rccl-benchmarking-results)in the Instinct performance benchmarking documentation for instructions.
...
[TransferBench benchmarking](https://instinct.docs.amd.com/projects/system-acceptance/en/latest/mi300x/performance-bench.html#transferbench-benchmarking-results)in the Instinct performance benchmarking documentation for instructions.
