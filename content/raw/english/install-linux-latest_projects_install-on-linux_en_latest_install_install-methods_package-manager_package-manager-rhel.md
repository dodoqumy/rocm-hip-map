---
title: "Red Hat Enterprise Linux native installation"
source_url: "https://rocm.docs.amd.com/projects/install-on-linux/en/latest/install/install-methods/package-manager/package-manager-rhel.html"
source_type: official
source_org: amd
credibility: 5
lifecycle: latest
fetched_at: 2026-05-02T21:14:38.461852+00:00
content_hash: "9a7340f2fdf62df9"
---

# Red Hat Enterprise Linux native installation[#](#red-hat-enterprise-linux-native-installation)
...
[amdgraphics]
name=AMD Graphics 7.2.1 repository
baseurl=https://repo.radeon.com/graphics/7.2.1/el/9.6/main/x86_64/
enabled=1
priority=50
gpgcheck=1
gpgkey=https://repo.radeon.com/rocm/rocm.gpg.key
...
[amdgraphics]
name=AMD Graphics 7.2.1 repository
baseurl=https://repo.radeon.com/graphics/7.2.1/el/9.4/main/x86_64/
enabled=1
priority=50
gpgcheck=1
gpgkey=https://repo.radeon.com/rocm/rocm.gpg.key
...
For information about the AMDGPU driver installation, see the [Red Hat Enterprise Linux native installation](https://instinct.docs.amd.com/projects/amdgpu-docs/en/latest/install/detailed-install/package-manager/package-manager-rhel.html) in the AMD Instinct Data Center GPU Documentation.
