...
- [Critical ROCm libraries for TensorFlow](#critical-rocm-libraries-for-tensorflow){.reference .internal .nav-link}
- [Supported and unsupported features](#supported-and-unsupported-features){.reference .internal .nav-link}
  - [Data types](#data-types){.reference .internal .nav-link}
  - [Features](#features){.reference .internal .nav-link}
  - [Distributed library features](#distributed-library-features){.reference .internal .nav-link}
- [Unsupported TensorFlow features](#unsupported-tensorflow-features){.reference .internal .nav-link}
...
::::: prev-next-area
[](pytorch-compatibility.html "previous page"){.left-prev}
...
[](jax-compatibility.html "next page"){.right-next}
