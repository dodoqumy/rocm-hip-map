...
source_url: "https://rocm.docs.amd.com/en/docs-7.0.0/conceptual/gpu-arch/mi350-performance-counters.html"
source_type: official
source_org: amd
credibility: 5
lifecycle: latest
fetched_at: 2026-05-02T15:04:15.688248+00:00
content_hash: "0143b3ff0394c9a7"
---
...
## Command processor packet processor counters (CPC)[#](#command-processor-packet-processor-counters-cpc)
...
## Shader pipe interpolators (SPI) counters[#](#shader-pipe-interpolators-spi-counters)
...
## Compute unit (SQ) counters[#](#compute-unit-sq-counters)
...
## Texture addressing (TA) unit counters[#](#texture-addressing-ta-unit-counters)
...
## Texture data (TD) unit counters[#](#texture-data-td-unit-counters)
...
## Texture cache per pipe (TCP) counters[#](#texture-cache-per-pipe-tcp-counters)
...
## Texture cache per channel (TCC) counters[#](#texture-cache-per-channel-tcc-counters)
