...
- [High-level overview: a CK GEMM instance](#high-level-overview-a-ck-gemm-instance){.reference .internal .nav-link}
  - [Template parameter definition](#template-parameter-definition){.reference .internal .nav-link}
    - [Matrix data precision](#matrix-data-precision){.reference .internal .nav-link}
    - [Matrix data layout](#matrix-data-layout){.reference .internal .nav-link}
    - [Matrix element operation](#matrix-element-operation){.reference .internal .nav-link}
    - [Tunable parameters](#tunable-parameters){.reference .internal .nav-link}
  - [Instantiating and running the templated kernel](#instantiating-and-running-the-templated-kernel){.reference .internal .nav-link}
- [Developing fused INT8 kernels for SmoothQuant models](#developing-fused-int8-kernels-for-smoothquant-models){.reference .internal .nav-link}
  - [Operation flow analysis](#operation-flow-analysis){.reference .internal .nav-link}
  - [Developing the complete function](#developing-the-complete-function){.reference .internal .nav-link}
  - [Binding to Python](#binding-to-python){.reference .internal .nav-link}
  - [INT8 model inference and performance](#int8-model-inference-and-performance){.reference .internal .nav-link}
- [Conclusion](#conclusion){.reference .internal .nav-link}
::::
:::::
::::::
...
::::: prev-next-area
[](model-acceleration-libraries.html "previous page"){.left-prev}
...
[](optimizing-triton-kernel.html "next page"){.right-next}
