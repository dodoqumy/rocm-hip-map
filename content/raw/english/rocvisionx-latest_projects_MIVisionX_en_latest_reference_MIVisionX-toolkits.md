---
title: "MIVisionX toolkits &#8212; MIVisionX 3.5.0 Documentation"
source_url: "https://rocm.docs.amd.com/projects/MIVisionX/en/latest/reference/MIVisionX-toolkits.html"
source_type: official
source_org: amd
credibility: 5
lifecycle: latest
fetched_at: 2026-05-02T21:11:05.543284+00:00
content_hash: "959ca55ae83837db"
---
...
<meta content="MIVisionX toolkits" name="description" />
<meta content="MIVisionX, ROCm, toolkits" name="keywords" />

    <title>MIVisionX toolkits &#8212; MIVisionX 3.5.0 Documentation</title>
...
<li class="toctree-l1 current active"><a class="current reference internal" href="#">Toolkits</a></li>
...
<nav aria-label="Breadcrumb" class="d-print-none">
  <ul class="bd-breadcrumbs">
    ...
    <li class="breadcrumb-item active" aria-current="page"><span class="ellipsis">MIVisionX toolkits</span></li>
  </ul>
</nav>
</div>
...
<div id="searchbox"></div>
  ...
  <section id="mivisionx-toolkits">
<span id="toolkit"></span><h1>MIVisionX toolkits<a class="headerlink" href="#mivisionx-toolkits" title="Link to this heading">#</a></h1>
<p>MIVisionX includes the <a class="reference external" href="https://github.com/ROCm/MIVisionX/tree/develop/toolkit/amd_data_analysis_toolkit">AMD data analysis toolkit (ADAT)</a> and the <a class="reference external" href="https://github.com/ROCm/MIVisionX/tree/develop/toolkit/amd_data_generation_toolkit">AMD data generation toolkit (ADGT)</a></p>
<p>ADAT is a set of neural network tools that help design, develop, quantize, prune, retrain, and infer a neural network in any framework.  The ADAT image and object classification tools can be used to analyze the results of image classification and object returned by any neural net model.</p>
<p>ADGT’s Classification Label Generator Toolkit (CLG-Toolset) creates a classification label validation list for a given image database and label set. It is used for renaming the dataset, resizing the images, and extracting metadata.</p>
</section>
...
<div class="prev-next-area">
    ...
    <a class="right-next"
       href="MIVisionX-env-variables.html"
       title="next page">
      <div class="prev-next-info">
