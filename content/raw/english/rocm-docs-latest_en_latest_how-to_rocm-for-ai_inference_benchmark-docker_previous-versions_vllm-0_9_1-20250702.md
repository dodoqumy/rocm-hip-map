...
source_url: "https://rocm.docs.amd.com/en/latest/how-to/rocm-for-ai/inference/benchmark-docker/previous-versions/vllm-0.9.1-20250702.html"
...
With this Docker image, you can quickly test the [[expected inference performance numbers]{.std .std-ref}](#vllm-benchmark-performance-measurements-20250702){.reference .internal} for MI300X Series GPUs.

::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: {#supported-models .section}
[]{#vllm-benchmark-available-models-20250702}
...
:::: {#vllm-benchmark-vllm-702 .model-doc .pyt-vllm-llama-3-1-8b .docutils .container}
::: {.admonition .note}
Note
...
See the [DBRX Instruct model card on Hugging Face](https://huggingface.co/docs/transformers/model_doc/dbrx){.reference .external} to learn more about your selected model. Some models require access authorization prior to use via an external license agreement through a third party.
:::
::::
...
[]{#vllm-benchmark-performance-measurements-20250702}
...
For information on experimental features and known issues related to ROCm optimization efforts on vLLM, see the developer's guide at [ROCm/vllm](https://github.com/ROCm/vllm/tree/5486e7bc8523be0324ccd68f221959445b56cc2a/docs/dev-docker){.github .reference .external}.
:::
...
Download the [ROCm vLLM Docker image](https://hub.docker.com/layers/rocm/vllm/rocm6.4.1_vllm_0.9.1_20250702/images/sha256-45068a2079cb8df554ed777141bf0c67d6627c470a897256e60c9f262677faab){.reference .external}. Use the following command to pull the Docker image from Docker Hub.
...
:::::::::::::::::::::: {#vllm-benchmark-mad-702 .model-doc .pyt-vllm-llama-3-1-8b .docutils .container}
::::::::::::::::::::: {.sd-tab-set .docutils}
...
Although the [[available models]{.std .std-ref}](#vllm-benchmark-available-models-20250702){.reference .internal} are preconfigured to collect latency and throughput performance data, you can also change the benchmarking parameters. See the standalone benchmarking tab for more information.
:::::::

Standalone benchmarking

::::::::::::::: {.sd-tab-content .docutils}
Run the vLLM benchmark tool independently by starting the [Docker container](https://hub.docker.com/layers/rocm/vllm/rocm6.4.1_vllm_0.9.1_20250702/images/sha256-45068a2079cb8df554ed777141bf0c67d6627c470a897256e60c9f262677faab){.reference .external} as shown in the following snippet.
...
- Latency benchmark
  ...
  Use this command to benchmark the latency of the Llama 3.1 8B model on eight GPUs with :literal\`float16\` precision.
...
- Latency benchmark
  ...
  Use this command to benchmark the latency of the Llama 3.1 70B model on eight GPUs with :literal\`float16\` precision.
...
- Latency benchmark
  ...
  Use this command to benchmark the latency of the Llama 3.1 405B model on eight GPUs with :literal\`float16\` precision.
...
- Latency benchmark
  ...
  Use this command to benchmark the latency of the Llama 2 7B model on eight GPUs with :literal\`float16\` precision.
...
- Latency benchmark
  ...
  Use this command to benchmark the latency of the Llama 2 70B model on eight GPUs with :literal\`float16\` precision.
...
- Latency benchmark
  ...
  Use this command to benchmark the latency of the Llama 3.1 8B FP8 model on eight GPUs with :literal\`float8\` precision.
...
- Latency benchmark
  ...
  Use this command to benchmark the latency of the Llama 3.1 70B FP8 model on eight GPUs with :literal\`float8\` precision.
...
- Latency benchmark
  ...
  Use this command to benchmark the latency of the Llama 3.1 405B FP8 model on eight GPUs with :literal\`float8\` precision.
...
- Latency benchmark
  ...
  Use this command to benchmark the latency of the Mixtral MoE 8x7B model on eight GPUs with :literal\`float16\` precision.
...
- Latency benchmark
  ...
  Use this command to benchmark the latency of the Mixtral MoE 8x22B model on eight GPUs with :literal\`float16\` precision.
...
- Latency benchmark
  ...
  Use this command to benchmark the latency of the Mistral 7B model on eight GPUs with :literal\`float16\` precision.
...
- Latency benchmark
  ...
  Use this command to benchmark the latency of the Mixtral MoE 8x7B FP8 model on eight GPUs with :literal\`float8\` precision.
...
- Latency benchmark
  ...
  Use this command to benchmark the latency of the Mixtral MoE 8x22B FP8 model on eight GPUs with :literal\`float8\` precision.
...
- Latency benchmark
  ...
  Use this command to benchmark the latency of the Mistral 7B FP8 model on eight GPUs with :literal\`float8\` precision.
...
- Latency benchmark
  ...
  Use this command to benchmark the latency of the Qwen2 7B model on eight GPUs with :literal\`float16\` precision.
...
- Latency benchmark
  ...
  Use this command to benchmark the latency of the Qwen2 72B model on eight GPUs with :literal\`float16\` precision.
...
- Latency benchmark
  ...
  Use this command to benchmark the latency of the QwQ-32B model on eight GPUs with :literal\`float16\` precision.
...
Use this command to run the performance benchmark test on the [DBRX Instruct](https://huggingface.co/docs/transformers/model_doc/dbrx){.reference .external} model using one GPU with the [`float16`{.docutils .literal .notranslate}]{.pre} data type on the host machine.
...
- Latency benchmark
  ...
  Use this command to benchmark the latency of the DBRX Instruct model on eight GPUs with :literal\`float16\` precision.
...
- Latency benchmark
  ...
  Use this command to benchmark the latency of the DBRX Instruct FP8 model on eight GPUs with :literal\`float8\` precision.
...
- Latency benchmark
  ...
  Use this command to benchmark the latency of the Gemma 2 27B model on eight GPUs with :literal\`float16\` precision.
...
- Latency benchmark
  ...
  Use this command to benchmark the latency of the C4AI Command R+ 08-2024 model on eight GPUs with :literal\`float16\` precision.
...
- Latency benchmark
  ...
  Use this command to benchmark the latency of the C4AI Command R+ 08-2024 FP8 model on eight GPUs with :literal\`float8\` precision.
...
- Latency benchmark
  ...
  Use this command to benchmark the latency of the DeepSeek MoE 16B model on eight GPUs with :literal\`float16\` precision.
...
- Latency benchmark
  ...
  Use this command to benchmark the latency of the Falcon 180B model on eight GPUs with :literal\`float16\` precision.
