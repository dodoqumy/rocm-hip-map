...
source_url: "https://rocm.docs.amd.com/en/docs-7.2.0/how-to/rocm-for-ai/fine-tuning/multi-gpu-fine-tuning-and-inference.html"
source_type: official
source_org: amd
credibility: 5
lifecycle: latest
fetched_at: 2026-05-02T15:02:57.229675+00:00
content_hash: "618049bf1c9fc175"
---

# Fine-tuning and inference using multiple GPUs[#](#fine-tuning-and-inference-using-multiple-gpus)
...
[Single-accelerator fine-tuning](single-gpu-fine-tuning-and-inference.html) for a single GPU setup.
...
[PyTorch installation guide](https://rocm.docs.amd.com/projects/install-on-linux/en/docs-7.2.0/install/3rd-party/pytorch-install.html). For consistent installation, it’s recommended to use official ROCm prebuilt Docker images with the framework pre-installed.In the Docker container, check the availability of ROCm-capable GPUs using the following command.
...
[torchtune](https://pytorch.org/torchtune/main/) is a PyTorch-native library for easy single and multi-GPU
