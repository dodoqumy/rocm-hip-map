...
source_url: "https://rocm.docs.amd.com/en/latest/how-to/rocm-for-ai/training/benchmark-docker/previous-versions/jax-maxtext-v25.11.html"
...
::::: {.sd-tab-set .docutils}
[`rocm/jax-training:maxtext-v25.11`{.docutils .literal .notranslate}]{.pre}
...
The [`rocm/jax-training:maxtext-v25.9`{.docutils .literal .notranslate}]{.pre} has been updated to [`rocm/jax-training:maxtext-v25.9.1`{.docutils .literal .notranslate}]{.pre}. This revision should include a fix to address segmentation fault issues during launch. See the [[versioned documentation]{.doc}](jax-maxtext-v25.9.html){.reference .internal}.
:::
...
[]{#amd-maxtext-model-support-v25-11}
...
[]{#amd-maxtext-multi-node-setup-v25-11}
...
[]{#amd-maxtext-get-started-v25-11}
...
::: {.sd-tab-content .docutils}
The following run command is tailored to Llama 2 7B. See [[Supported models]{.std .std-ref}](#amd-maxtext-model-support-v25-11){.reference .internal} to switch to another available model.
...
:::::::: {.sd-tab-content .docutils}
The following commands are optimized for Llama 2 7B. See [[Supported models]{.std .std-ref}](#amd-maxtext-model-support-v25-11){.reference .internal} to switch to another available model. Some instructions and resources might not be available for all models and configurations.
...
If you need to collect a trace and the JAX profiler isn't working, use [`rocprofv3`{.docutils .literal .notranslate}]{.pre} provided by the [[ROCprofiler-SDK]{.xref .std .std-doc}](https://rocm.docs.amd.com/projects/rocprofiler-sdk/en/latest/index.html "(in Rocprofiler SDK v1.1.0)"){.reference .external} as a workaround. For example:
...
You can set the directory where you want the .json traces to be saved using [`-d`{.docutils .literal .notranslate}]{.pre}` `{.docutils .literal .notranslate}[`<TRACE_DIRECTORY>`{.docutils .literal .notranslate}]{.pre}. The resulting traces can be opened in Perfetto: [https://ui.perfetto.dev/](https://ui.perfetto.dev/){.reference .external}.
::::::::
::::::::::
:::::::::::
...
::: {.sd-tab-content .docutils}
The following run command is tailored to Llama 2 70B. See [[Supported models]{.std .std-ref}](#amd-maxtext-model-support-v25-11){.reference .internal} to switch to another available model.
...
:::::::: {.sd-tab-content .docutils}
The following commands are optimized for Llama 2 70B. See [[Supported models]{.std .std-ref}](#amd-maxtext-model-support-v25-11){.reference .internal} to switch to another available model. Some instructions and resources might not be available for all models and configurations.
...
:::::::: {.sd-tab-content .docutils}
The following commands are optimized for Llama 3 8B (multi-node). See [[Supported models]{.std .std-ref}](#amd-maxtext-model-support-v25-11){.reference .internal} to switch to another available model. Some instructions and resources might not be available for all models and configurations.
...
:::::::: {.sd-tab-content .docutils}
The following commands are optimized for Llama 3 70B (multi-node). See [[Supported models]{.std .std-ref}](#amd-maxtext-model-support-v25-11){.reference .internal} to switch to another available model. Some instructions and resources might not be available for all models and configurations.
...
::: {.sd-tab-content .docutils}
The following run command is tailored to Llama 3.1 8B. See [[Supported models]{.std .std-ref}](#amd-maxtext-model-support-v25-11){.reference .internal} to switch to another available model.
...
::::: {.sd-tab-content .docutils}
The following commands are optimized for Llama 3.1 8B. See [[Supported models]{.std .std-ref}](#amd-maxtext-model-support-v25-11){.reference .internal} to switch to another available model. Some instructions and resources might not be available for all models and configurations.
...
For multi-node training examples, choose a model from [[Supported models]{.std .std-ref}](#amd-maxtext-model-support-v25-11){.reference .internal} with an available [multi-node training script](https://github.com/ROCm/MAD/tree/develop/scripts/jax-maxtext/gpu-rocm){.reference .external}.
:::::
:::::::
::::::::
...
::: {.sd-tab-content .docutils}
The following run command is tailored to Llama 3.1 70B. See [[Supported models]{.std .std-ref}](#amd-maxtext-model-support-v25-11){.reference .internal} to switch to another available model.
...
::::: {.sd-tab-content .docutils}
The following commands are optimized for Llama 3.1 70B. See [[Supported models]{.std .std-ref}](#amd-maxtext-model-support-v25-11){.reference .internal} to switch to another available model. Some instructions and resources might not be available for all models and configurations.
...
::: {.sd-tab-content .docutils}
The following run command is tailored to Llama 3.3 70B. See [[Supported models]{.std .std-ref}](#amd-maxtext-model-support-v25-11){.reference .internal} to switch to another available model.
...
::::: {.sd-tab-content .docutils}
The following commands are optimized for Llama 3.3 70B. See [[Supported models]{.std .std-ref}](#amd-maxtext-model-support-v25-11){.reference .internal} to switch to another available model. Some instructions and resources might not be available for all models and configurations.
...
::: {.sd-tab-content .docutils}
The following run command is tailored to DeepSeek-V2-Lite (16B). See [[Supported models]{.std .std-ref}](#amd-maxtext-model-support-v25-11){.reference .internal} to switch to another available model.
...
::::: {.sd-tab-content .docutils}
The following commands are optimized for DeepSeek-V2-Lite (16B). See [[Supported models]{.std .std-ref}](#amd-maxtext-model-support-v25-11){.reference .internal} to switch to another available model. Some instructions and resources might not be available for all models and configurations.
...
::: {.sd-tab-content .docutils}
The following run command is tailored to Mixtral 8x7B. See [[Supported models]{.std .std-ref}](#amd-maxtext-model-support-v25-11){.reference .internal} to switch to another available model.
...
::::: {.sd-tab-content .docutils}
The following commands are optimized for Mixtral 8x7B. See [[Supported models]{.std .std-ref}](#amd-maxtext-model-support-v25-11){.reference .internal} to switch to another available model. Some instructions and resources might not be available for all models and configurations.
...
- You might see minor loss spikes, or loss curve may have slightly higher convergence end values compared to the previous [`jax-training`{.docutils .literal .notranslate}]{.pre} image.

- For FP8 training on MI355, many models will display a warning message like: [`Warning:`{.docutils .literal .notranslate}]{.pre}` `{.docutils .literal .notranslate}[`Latency`{.docutils .literal .notranslate}]{.pre}` `{.docutils .literal .notranslate}[`not`{.docutils .literal .notranslate}]{.pre}` `{.docutils .literal .notranslate}[`found`{.docutils .literal .notranslate}]{.pre}` `{.docutils .literal .notranslate}[`for`{.docutils .literal .notranslate}]{.pre}` `{.docutils .literal .notranslate}[`MI_M=16,`{.docutils .literal .notranslate}]{.pre}` `{.docutils .literal .notranslate}[`MI_N=16,`{.docutils .literal .notranslate}]{.pre}` `{.docutils .literal .notranslate}[`MI_K=128,`{.docutils .literal .notranslate}]{.pre}` `{.docutils .literal .notranslate}[`mi_input_type=BFloat8Float8_fnuz.`{.docutils .literal .notranslate}]{.pre}` `{.docutils .literal .notranslate}[`Returning`{.docutils .literal .notranslate}]{.pre}` `{.docutils .literal .notranslate}[`latency`{.docutils .literal .notranslate}]{.pre}` `{.docutils .literal .notranslate}[`value`{.docutils .literal .notranslate}]{.pre}` `{.docutils .literal .notranslate}[`of`{.docutils .literal .notranslate}]{.pre}` `{.docutils .literal .notranslate}[`32`{.docutils .literal .notranslate}]{.pre}` `{.docutils .literal .notranslate}[`(really`{.docutils .literal .notranslate}]{.pre}` `{.docutils .literal .notranslate}[`slow).`{.docutils .literal .notranslate}]{.pre} The compile step may take longer than usual, but training will run. This will be fixed in a future release.

- The built-in JAX profiler isn't working. If you need to collect a trace and the JAX profiler isn't working, use [`rocprofv3`{.docutils .literal .notranslate}]{.pre} provided by the [[ROCprofiler-SDK]{.xref .std .std-doc}](https://rocm.docs.amd.com/projects/rocprofiler-sdk/en/latest/index.html "(in Rocprofiler SDK v1.1.0)"){.reference .external} as a workaround. For example:
