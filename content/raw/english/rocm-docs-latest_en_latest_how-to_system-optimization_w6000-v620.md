...
- [Workstation workloads](#workstation-workloads){.reference .internal .nav-link}
- [System settings](#system-settings){.reference .internal .nav-link}
  - [System BIOS settings](#system-bios-settings){.reference .internal .nav-link}
  - [Operating system settings](#operating-system-settings){.reference .internal .nav-link}
  - [Guest OS installation](#guest-os-installation){.reference .internal .nav-link}
::::
:::::
::::::
