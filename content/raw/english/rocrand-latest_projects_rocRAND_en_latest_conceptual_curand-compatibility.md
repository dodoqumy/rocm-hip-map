---
title: "cuRAND compatibility &#8212; rocRAND 4.2.0 Documentation"
source_url: "https://rocm.docs.amd.com/projects/rocRAND/en/latest/conceptual/curand-compatibility.html"
source_type: official
source_org: amd
credibility: 5
lifecycle: latest
fetched_at: 2026-05-02T21:08:02.549880+00:00
content_hash: "8d084cee9cfda3ad"
---
...
<meta content="rocRAND compatibility with cuRAND" name="description" />
<meta content="rocRAND, ROCm, API, documentation, cuRAND" name="keywords" />

    <title>cuRAND compatibility &#8212; rocRAND 4.2.0 Documentation</title>
...
<link rel="preload" as="script" href="../_static/scripts/pydata-sphinx-theme.js?digest=8878045cc6db502f8baf" />
    ...
    <script>DOCUMENTATION_OPTIONS.pagename = 'conceptual/curand-compatibility';</script>
    <script async="async" src="https://download.amd.com/js/analytics/analyticsinit.js"></script>
    <link rel="icon" href="https://www.amd.com/content/dam/code/images/favicon/favicon.ico"/>
    <link rel="index" title="Index" href="../genindex.html" />
    <link rel="search" title="Search" href="../search.html" />
    <link rel="next" title="Kernel configurations for dynamic ordering" href="dynamic_ordering_configuration.html" />
    <link rel="prev" title="rocRAND programming guide" href="programmers-guide.html" />
    <meta name="google-site-verification" content="vo35SZt_GASsTHAEmdww7AYKPCvZyzLvOXBl8guBME4" />

  <script async type="text/javascript" src="/_/static/javascript/readthedocs-addons.js"></script><meta name="readthedocs-project-slug" content="advanced-micro-devices-rocrand" /><meta name="readthedocs-version-slug" content="latest" /><meta name="readthedocs-resolver-filename" content="/conceptual/curand-compatibility.html" /><meta name="readthedocs-http-status" content="200" /></head>
...
<li class="toctree-l1 current active"><a class="current reference internal" href="#">cuRAND compatibility</a></li>
...
<nav aria-label="Breadcrumb" class="d-print-none">
  <ul class="bd-breadcrumbs">
    ...
    <li class="breadcrumb-item active" aria-current="page"><span class="ellipsis">cuRAND compatibility</span></li>
  </ul>
</nav>
</div>
...
<div id="searchbox"></div>
  ...
  <section id="curand-compatibility">
<span id="id1"></span><h1>cuRAND compatibility<a class="headerlink" href="#curand-compatibility" title="Link to this heading">#</a></h1>
<p>The following table shows which rocRAND generators produce the exact same sequence as the equivalent NVIDIA CUDA cuRAND generator when using legacy ordering, given the same seed, number of dimensions, and offset.</p>
<div class="pst-scrollable-table-container"><table class="table" id="id2">
<caption><span class="caption-number">Table 10 </span><span class="caption-text">cuRAND compatibility</span><a class="headerlink" href="#id2" title="Link to this table">#</a></caption>
<thead>
...
<tr class="row-odd"><td><p>Philox 32x4-10</p></td>
<td><p>No</p></td>
</tr>
...
<td><p>Yes, with same offset</p></td>
</tr>
