...
- [Model architecture](#model-architecture){.reference .internal .nav-link}
- [Training parameters](#training-parameters){.reference .internal .nav-link}
- [Backward compatibility with Megatron-LM](#backward-compatibility-with-megatron-lm){.reference .internal .nav-link}
::::
:::::
::::::
