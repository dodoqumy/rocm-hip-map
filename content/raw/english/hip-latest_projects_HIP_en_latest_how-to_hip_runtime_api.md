---
title: "Using HIP runtime API &#8212; HIP 7.2.53211 Documentation"
source_url: "https://rocm.docs.amd.com/projects/HIP/en/latest/how-to/hip_runtime_api.html"
source_type: official
source_org: amd
credibility: 5
lifecycle: latest
fetched_at: 2026-05-01T09:06:31.684127+00:00
content_hash: "8db48ae5983fb0fe"
---
...
<meta content="HIP runtime API usage" name="description" />
<meta content="AMD, ROCm, HIP, HIP runtime API How to," name="keywords" />

    <title>Using HIP runtime API &#8212; HIP 7.2.53211 Documentation</title>
...
<link rel="preload" as="script" href="../_static/scripts/pydata-sphinx-theme.js?digest=dfe6caa3a7d634c4db9b" />
  <script src="../_static/vendor/fontawesome/6.5.2/js/all.min.js?digest=dfe6caa3a7d634c4db9b"></script>
    ...
    <script>DOCUMENTATION_OPTIONS.pagename = 'how-to/hip_runtime_api';</script>
    <script async="async" src="https://download.amd.com/js/analytics/analyticsinit.js"></script>
    <link rel="icon" href="https://www.amd.com/content/dam/code/images/favicon/favicon.ico"/>
    <link rel="index" title="Index" href="../genindex.html" />
    <link rel="search" title="Search" href="../search.html" />
    <link rel="next" title="Initialization" href="hip_runtime_api/initialization.html" />
    <link rel="prev" title="Logging HIP activity" href="logging.html" />
    <meta name="google-site-verification" content="vo35SZt_GASsTHAEmdww7AYKPCvZyzLvOXBl8guBME4" />

  <script async type="text/javascript" src="/_/static/javascript/readthedocs-addons.js"></script><meta name="readthedocs-project-slug" content="advanced-micro-devices-hip" /><meta name="readthedocs-version-slug" content="latest" /><meta name="readthedocs-resolver-filename" content="/how-to/hip_runtime_api.html" /><meta name="readthedocs-http-status" content="200" /></head>
...
<li class="toctree-l1 current active has-children"><a class="current reference internal" href="#">Using HIP runtime API</a><details open="open"><summary><span class="toctree-toggle" role="presentation"><i class="fa-solid fa-chevron-down"></i></span></summary><ul>
...
<nav aria-label="Breadcrumb" class="d-print-none">
  <ul class="bd-breadcrumbs">
    ...
    <li class="breadcrumb-item active" aria-current="page">Using HIP...</li>
  </ul>
</nav>
</div>
...
<div id="searchbox"></div>
  ...
  <section id="using-hip-runtime-api">
<span id="hip-runtime-api-how-to"></span><h1>Using HIP runtime API<a class="headerlink" href="#using-hip-runtime-api" title="Link to this heading">#</a></h1>
<p>The HIP runtime API provides C and C++ functionalities to manage event, stream,
and memory on GPUs. The HIP runtime uses <a class="reference internal" href="../understand/amd_clr.html"><span class="doc">Compute Language Runtime (CLR)</span></a>.</p>
<p>CLR contains source code for AMD ROCm’s compute language runtimes: <code class="docutils literal notranslate"><span class="pre">HIP</span></code> and
<code class="docutils literal notranslate"><span class="pre">OpenCL™</span></code>. CLR includes the <code class="docutils literal notranslate"><span class="pre">HIP</span></code> implementation on the AMD ROCm
platform: <a class="reference external" href="https://github.com/ROCm/rocm-systems/tree/develop/projects/clr/hipamd">hipamd</a> and the
ROCm Compute Language Runtime (<code class="docutils literal notranslate"><span class="pre">rocclr</span></code>). <code class="docutils literal notranslate"><span class="pre">rocclr</span></code> is a
virtual device interface that enables the HIP runtime to interact with
different backends, such as <a class="reference external" href="https://rocm.docs.amd.com/projects/ROCR-Runtime/en/latest/index.html" title="(in ROCR Documentation v1.18.0)"><span class="xref std std-doc">ROCr</span></a> on Linux or PAL on
Microsoft Windows. CLR also includes the <a class="reference external" href="https://github.com/ROCm/rocm-systems/tree/develop/projects/clr/opencl">OpenCL runtime</a>
implementation.</p>
<p>The HIP runtime API backends are summarized in the following figure:</p>
<figure class="align-default">
<img alt="../_images/runtimes.svg" src="../_images/runtimes.svg" />
</figure>
<p>Here are the various HIP Runtime API high level functions:</p>
<ul class="simple">
<li><p><a class="reference internal" href="hip_runtime_api/initialization.html"><span class="doc">Initialization</span></a></p></li>
<li><p><a class="reference internal" href="hip_runtime_api/memory_management.html"><span class="doc">Memory management</span></a></p></li>
<li><p><a class="reference internal" href="hip_runtime_api/error_handling.html"><span class="doc">Error handling</span></a></p></li>
<li><p><a class="reference internal" href="hip_runtime_api/asynchronous.html"><span class="doc">Asynchronous concurrent execution</span></a></p></li>
<li><p><a class="reference internal" href="hip_runtime_api/cooperative_groups.html"><span class="doc">Cooperative groups</span></a></p></li>
<li><p><a class="reference internal" href="hip_runtime_api/hipgraph.html"><span class="doc">HIP graphs</span></a></p></li>
<li><p><a class="reference internal" href="hip_runtime_api/call_stack.html"><span class="doc">Call stack</span></a></p></li>
<li><p><a class="reference internal" href="hip_runtime_api/multi_device.html"><span class="doc">Multi-device management</span></a></p></li>
<li><p><a class="reference internal" href="hip_runtime_api/opengl_interop.html"><span class="doc">OpenGL interoperability</span></a></p></li>
<li><p><a class="reference internal" href="hip_runtime_api/external_interop.html"><span class="doc">External resource interoperability</span></a></p></li>
</ul>
...
<div class="prev-next-area">
    <a class="left-prev"
      ...
      <div class="prev-next-info">
        ...
        <p class="prev-next-title">Logging HIP activity</p>
      </div>
    </a>
    <a class="right-next"
       href="hip_runtime_api/initialization.html"
       title="next page">
      <div class="prev-next-info">
