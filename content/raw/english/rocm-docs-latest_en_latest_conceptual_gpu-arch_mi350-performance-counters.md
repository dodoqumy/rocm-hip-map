...
source_url: "https://rocm.docs.amd.com/en/latest/conceptual/gpu-arch/mi350-performance-counters.html"
...
- [Command processor packet processor counters (CPC)](#command-processor-packet-processor-counters-cpc){.reference .internal .nav-link}
- [Shader pipe interpolators (SPI) counters](#shader-pipe-interpolators-spi-counters){.reference .internal .nav-link}
- [Compute unit (SQ) counters](#compute-unit-sq-counters){.reference .internal .nav-link}
- [Texture addressing (TA) unit counters](#texture-addressing-ta-unit-counters){.reference .internal .nav-link}
- [Texture data (TD) unit counters](#texture-data-td-unit-counters){.reference .internal .nav-link}
- [Texture cache per pipe (TCP) counters](#texture-cache-per-pipe-tcp-counters){.reference .internal .nav-link}
- [Texture cache per channel (TCC) counters](#texture-cache-per-channel-tcc-counters){.reference .internal .nav-link}
::::
:::::
::::::
...
:::::::::::::::::::::::::: {#mi350-series-performance-counters .section}
# MI350 Series performance counters[\#](#mi350-series-performance-counters "Link to this heading"){.headerlink}
...
This topic lists and describes the hardware performance counters and derived metrics available on the AMD Instinct MI350 and MI355 GPUs. These counters are available for profiling using [ROCprofiler-SDK](https://rocm.docs.amd.com/projects/rocprofiler-sdk/en/latest/index.html){.reference .external} and [ROCm Compute Profiler](https://rocm.docs.amd.com/projects/rocprofiler-compute/en/latest/){.reference .external}.

The following sections list the performance counters based on the IP blocks.

:::: {#command-processor-packet-processor-counters-cpc .section}
## Command processor packet processor counters (CPC)[\#](#command-processor-packet-processor-counters-cpc "Link to this heading"){.headerlink}
...
:::: {#shader-pipe-interpolators-spi-counters .section}
## Shader pipe interpolators (SPI) counters[\#](#shader-pipe-interpolators-spi-counters "Link to this heading"){.headerlink}
...
:::: {#compute-unit-sq-counters .section}
## Compute unit (SQ) counters[\#](#compute-unit-sq-counters "Link to this heading"){.headerlink}

::: pst-scrollable-table-container
  Hardware counter                 Definition
  -------------------------------- ----------------------------------------------------------------------------------------------------------------------------------------
  SQ_INSTS_VALU_MFMA_F6F4          Number of VALU V_MFMA\_\*\_F6F4 instructions.
...
:::: {#texture-addressing-ta-unit-counters .section}
## Texture addressing (TA) unit counters[\#](#texture-addressing-ta-unit-counters "Link to this heading"){.headerlink}
...
:::: {#texture-data-td-unit-counters .section}
## Texture data (TD) unit counters[\#](#texture-data-td-unit-counters "Link to this heading"){.headerlink}
...
:::: {#texture-cache-per-pipe-tcp-counters .section}
## Texture cache per pipe (TCP) counters[\#](#texture-cache-per-pipe-tcp-counters "Link to this heading"){.headerlink}
...
:::: {#texture-cache-per-channel-tcc-counters .section}
## Texture cache per channel (TCC) counters[\#](#texture-cache-per-channel-tcc-counters "Link to this heading"){.headerlink}
...
::::: prev-next-area
[](mi300-mi200-performance-counters.html "previous page"){.left-prev}
...
[](mi250.html "next page"){.right-next}
