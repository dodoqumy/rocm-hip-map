...
source_url: "https://rocm.docs.amd.com/en/docs-6.4.0/how-to/rocm-for-ai/fine-tuning/multi-gpu-fine-tuning-and-inference.html"
source_type: official
source_org: amd
credibility: 5
lifecycle: latest
fetched_at: 2026-05-04T15:22:38.967836+00:00
content_hash: "32a1f05acce9d36f"
---
...
[PyTorch installation guide](https://rocm.docs.amd.com/projects/install-on-linux/en/docs-6.4.0/install/3rd-party/pytorch-install.html). For consistent installation, it’s recommended to use official ROCm prebuilt Docker images with the framework pre-installed.In the Docker container, check the availability of ROCM-capable accelerators using the following command.
