---
title: "rocThrust and policies &#8212; rocThrust Documentation 4.2.0 documentation"
source_url: "https://rocm.docs.amd.com/projects/rocThrust/en/latest/reference/rocThrust-hip-policies.html"
source_type: official
source_org: amd
credibility: 5
lifecycle: latest
fetched_at: 2026-05-02T21:19:34.224335+00:00
content_hash: "2e62b58d151c9d87"
---

# rocThrust and policies[#](#rocthrust-and-policies)

In addition to the standard Thrust execution policies (eg. `thrust::host`
...
- This policy causes algorithms to be launched in a parallel configuration. API calls are blocking (synchronous with respect to the host).`hip_rocprim::par_nosync`

- This policy tells Thrust that algorithms may avoid synchronization barriers when it is possible to do so. As a result, algorithms may be launched asynchronously with respect to the host. This can allow you to perform other host-side work while the algorithms are running on the device. If you use this policy, you must synchronize before accessing results on the host side.
