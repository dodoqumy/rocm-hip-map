...
- [Finding dependencies](#finding-dependencies){.reference .internal .nav-link}
- [Using HIP in CMake](#using-hip-in-cmake){.reference .internal .nav-link}
  - [Using the HIP single-source programming model](#using-the-hip-single-source-programming-model){.reference .internal .nav-link}
  - [Consuming ROCm C/C++ libraries](#consuming-rocm-c-c-libraries){.reference .internal .nav-link}
  - [Consuming the HIP API in C++ code](#consuming-the-hip-api-in-c-code){.reference .internal .nav-link}
  - [Compiling device code in C++ language mode](#compiling-device-code-in-c-language-mode){.reference .internal .nav-link}
  - [ROCm CMake packages](#rocm-cmake-packages){.reference .internal .nav-link}
- [Using CMake presets](#using-cmake-presets){.reference .internal .nav-link}
  - [Using HIP with presets](#using-hip-with-presets){.reference .internal .nav-link}
::::
:::::
::::::
...
::::: prev-next-area
[](gpu-isolation.html "previous page"){.left-prev}
...
[](ai-pytorch-inception.html "next page"){.right-next}
