...
source_url: "https://rocm.docs.amd.com/en/docs-6.4.0/contribute/building.html"
source_type: official
source_org: amd
credibility: 5
lifecycle: latest
fetched_at: 2026-05-04T16:06:56.332492+00:00
content_hash: "66d652f0dd17afed"
---
...
See the `build.tools.python`

setting in the [Read the Docs configuration file](https://github.com/ROCm/ROCm/blob/develop/.readthedocs.yaml) for the Python version used by Read the Docs to build documentation.
...
: Sets the root of the output website for live previews. Must be changed alongside the`tasks.json`
...
environment and`docs/sphinx/requirements.txt`
