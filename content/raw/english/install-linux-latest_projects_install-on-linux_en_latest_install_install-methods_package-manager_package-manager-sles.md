---
title: "SUSE Linux Enterprise Server native installation"
source_url: "https://rocm.docs.amd.com/projects/install-on-linux/en/latest/install/install-methods/package-manager/package-manager-sles.html"
source_type: official
source_org: amd
credibility: 5
lifecycle: latest
fetched_at: 2026-05-02T21:14:11.226326+00:00
content_hash: "58faa1736a4657ca"
---

# SUSE Linux Enterprise Server native installation[#](#suse-linux-enterprise-server-native-installation)
...
```
tee /etc/zypp/repos.d/rocm.repo <<EOF
[rocm]
...
For information about the AMDGPU driver installation, see the [SUSE Linux Enterprise Server native installation](https://instinct.docs.amd.com/projects/amdgpu-docs/en/latest/install/detailed-install/package-manager/package-manager-sles.html) in the AMD Instinct Data Center GPU Documentation.
...
```
zypper --gpg-auto-import-keys install rocm
```
