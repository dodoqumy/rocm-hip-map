---
title: "Porting from NVIDIA CUDA to hipSPARSELt &#8212; hipSPARSELt 0.2.6 Documentation"
source_url: "https://rocm.docs.amd.com/projects/hipSPARSELt/en/latest/how-to/porting.html"
source_type: official
source_org: amd
credibility: 5
lifecycle: latest
fetched_at: 2026-05-02T21:07:29.831514+00:00
content_hash: "d3b3b3d53c8327f8"
---
...
<meta content="Porting from CUDA to hipSPARSELt" name="description" />
<meta content="hipSPARSELt, ROCm, porting from CUDA, porting" name="keywords" />

    <title>Porting from NVIDIA CUDA to hipSPARSELt &#8212; hipSPARSELt 0.2.6 Documentation</title>
...
<link rel="preload" as="script" href="../_static/scripts/pydata-sphinx-theme.js?digest=8878045cc6db502f8baf" />
    ...
    <script>DOCUMENTATION_OPTIONS.pagename = 'how-to/porting';</script>
    <script async="async" src="https://download.amd.com/js/analytics/analyticsinit.js"></script>
    <link rel="icon" href="https://www.amd.com/content/dam/code/images/favicon/favicon.ico"/>
    <link rel="index" title="Index" href="../genindex.html" />
    <link rel="search" title="Search" href="../search.html" />
    <link rel="next" title="Supported ROCm and NVIDIA CUDA functions" href="../reference/supported-functions.html" />
    <link rel="prev" title="HIP device and stream management" href="device-stream-management.html" />
    <meta name="google-site-verification" content="vo35SZt_GASsTHAEmdww7AYKPCvZyzLvOXBl8guBME4" />

  <script async type="text/javascript" src="/_/static/javascript/readthedocs-addons.js"></script><meta name="readthedocs-project-slug" content="advanced-micro-devices-hipsparselt" /><meta name="readthedocs-version-slug" content="latest" /><meta name="readthedocs-resolver-filename" content="/how-to/porting.html" /><meta name="readthedocs-http-status" content="200" /></head>
...
<li class="toctree-l1"><a class="reference internal" href="device-stream-management.html">Manage devices and streams</a></li>
<li class="toctree-l1 current active"><a class="current reference internal" href="#">Port from NVIDIA CUDA</a></li>
</ul>
...
<nav aria-label="Breadcrumb" class="d-print-none">
  <ul class="bd-breadcrumbs">
    ...
    <li class="breadcrumb-item active" aria-current="page"><span class="ellipsis">Porting from NVIDIA CUDA to hipSPARSELt</span></li>
  </ul>
</nav>
</div>
...
<div id="jb-print-docs-body" class="onlyprint">
    <h1>Porting from NVIDIA CUDA to hipSPARSELt</h1>
    <!-- Table of contents -->
...
<div id="searchbox"></div>
  ...
  <section id="porting-from-nvidia-cuda-to-hipsparselt">
<span id="porting"></span><h1>Porting from NVIDIA CUDA to hipSPARSELt<a class="headerlink" href="#porting-from-nvidia-cuda-to-hipsparselt" title="Link to this heading">#</a></h1>
<p>The hipSPARSELt interface is compatible with cuSPARSELt APIs. Porting a CUDA application that
originally calls the cuSPARSELt API to an application that calls the hipSPARSELt API should be relatively
straightforward.</p>
<p>For example, the hipSPARSELt matrix multiplication interface in the API is:</p>
<div class="highlight-c notranslate"><div class="highlight"><pre><span></span><span class="n">hipsparseStatus_t</span><span class="w"> </span><span class="nf">hipsparseLtMatmul</span><span class="p">(</span><span class="k">const</span><span class="w"> </span><span class="n">hipsparseLtHandle_t</span><span class="o">*</span><span class="w">     </span><span class="n">handle</span><span class="p">,</span>
<span class="w">                                    </span><span class="k">const</span><span class="w"> </span><span class="n">hipsparseLtMatmulPlan_t</span><span class="o">*</span><span class="w"> </span><span class="n">plan</span><span class="p">,</span>
...
<span class="w">                                    </span><span class="k">const</span><span class="w"> </span><span class="kt">void</span><span class="o">*</span><span class="w">                    </span><span class="n">d_A</span><span class="p">,</span>
<span class="w">                                    </span><span class="k">const</span><span class="w"> </span><span class="kt">void</span><span class="o">*</span><span class="w">                    </span><span class="n">d_B</span><span class="p">,</span>
...
<span class="w">                                    </span><span class="k">const</span><span class="w"> </span><span class="kt">void</span><span class="o">*</span><span class="w">                    </span><span class="n">d_C</span><span class="p">,</span>
<span class="w">                                    </span><span class="kt">void</span><span class="o">*</span><span class="w">                          </span><span class="n">d_D</span><span class="p">,</span>
<span class="w">                                    </span><span class="kt">void</span><span class="o">*</span><span class="w">                          </span><span class="n">workspace</span><span class="p">,</span>
...
<span class="w">                                    </span><span class="kt">int32_t</span><span class="w">                        </span><span class="n">numStreams</span><span class="p">);</span>
</pre></div>
</div>
<p>hipSPARSELt assumes matrices <code class="docutils literal notranslate"><span class="pre">A</span></code>, <code class="docutils literal notranslate"><span class="pre">B</span></code>, <code class="docutils literal notranslate"><span class="pre">C</span></code>, <code class="docutils literal notranslate"><span class="pre">D</span></code>, and <code class="docutils literal notranslate"><span class="pre">workspace</span></code> are allocated in the GPU memory space and filled with
data. Users are responsible for copying data to and from the host and device memory.</p>
</section>
...
<div class="prev-next-area">
    <a class="left-prev"
       href="device-stream-management.html"
       title="previous page">
    ...
    <a class="right-next"
       href="../reference/supported-functions.html"
       title="next page">
      <div class="prev-next-info">
