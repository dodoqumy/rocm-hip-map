---
title: "Quick start hipSPARSELt installation guide &#8212; hipSPARSELt 0.2.6 Documentation"
source_url: "https://rocm.docs.amd.com/projects/hipSPARSELt/en/latest/install/quick-start-install.html"
source_type: official
source_org: amd
credibility: 5
lifecycle: latest
fetched_at: 2026-05-02T18:07:41.315964+00:00
content_hash: "c49b8ca1d2370ee0"
---
...
<meta content="Quick-start: Installing hipSPARSELt on Linux" name="description" />
<meta content="hipSPARSELt, ROCm, install, Linux, quick-start" name="keywords" />

    <title>Quick start hipSPARSELt installation guide &#8212; hipSPARSELt 0.2.6 Documentation</title>
...
<link rel="preload" as="script" href="../_static/scripts/pydata-sphinx-theme.js?digest=8878045cc6db502f8baf" />
    ...
    <script>DOCUMENTATION_OPTIONS.pagename = 'install/quick-start-install';</script>
    <script async="async" src="https://download.amd.com/js/analytics/analyticsinit.js"></script>
    <link rel="icon" href="https://www.amd.com/content/dam/code/images/favicon/favicon.ico"/>
    <link rel="index" title="Index" href="../genindex.html" />
    <link rel="search" title="Search" href="../search.html" />
    <link rel="next" title="Installing and building hipSPARSELt" href="install-hipsparselt.html" />
    <link rel="prev" title="What is hipSPARSELt?" href="../what-is-hipsparselt.html" />
    <meta name="google-site-verification" content="vo35SZt_GASsTHAEmdww7AYKPCvZyzLvOXBl8guBME4" />

  <script async type="text/javascript" src="/_/static/javascript/readthedocs-addons.js"></script><meta name="readthedocs-project-slug" content="advanced-micro-devices-hipsparselt" /><meta name="readthedocs-version-slug" content="latest" /><meta name="readthedocs-resolver-filename" content="/install/quick-start-install.html" /><meta name="readthedocs-http-status" content="200" /></head>
...
<li class="toctree-l1"><a class="reference internal" href="install-hipsparselt.html">Detailed installation guide</a></li>
</ul>
...
<nav aria-label="Breadcrumb" class="d-print-none">
  <ul class="bd-breadcrumbs">
    ...
    <li class="breadcrumb-item active" aria-current="page"><span class="ellipsis">Quick start hipSPARSELt installation guide</span></li>
  </ul>
</nav>
</div>
...
<div id="jb-print-docs-body" class="onlyprint">
    <h1>Quick start hipSPARSELt installation guide</h1>
    <!-- Table of contents -->
...
<div id="searchbox"></div>
  ...
  <section id="quick-start-hipsparselt-installation-guide">
<span id="install-linux-quick"></span><h1>Quick start hipSPARSELt installation guide<a class="headerlink" href="#quick-start-hipsparselt-installation-guide" title="Link to this heading">#</a></h1>
<p>The root directory of the <a class="reference external" href="https://github.com/ROCm/rocm-libraries/tree/develop/projects/hipsparselt">hipSPARSELt project</a>
within the <a class="reference external" href="https://github.com/ROCm/rocm-libraries">rocm-libraries GitHub</a> contains the
helper bash script <code class="docutils literal notranslate"><span class="pre">install.sh</span></code> for building and installing hipSPARSELt on Ubuntu with a single command. The
...
and install hipSPARSELt. Some commands require <code class="docutils literal notranslate"><span class="pre">sudo</span></code> access, so the script might prompt you for a password.</p>
<div class="highlight-bash notranslate"><div class="highlight"><pre><span></span><span class="c1"># Run install.sh script</span>
<span class="c1"># Command line options:</span>
<span class="c1">#   -h|--help            - prints help message</span>
<span class="c1">#   -i|--install         - install after build</span>
<span class="c1">#   -d|--dependencies    - install build dependencies</span>
<span class="c1">#   -c|--clients         - build library clients too (combines with -i &amp; -d)</span>
<span class="c1">#   -g|--debug           - build with debug flag</span>
<span class="c1">#   -k|--relwithdebinfo  - build with RelWithDebInfo</span>

./install.sh<span class="w"> </span>-dc
</pre></div>
</div>
<p>For more detailed installation instructions, see <a class="reference internal" href="install-hipsparselt.html#install-linux"><span class="std std-ref">Installing and building hipSPARSELt</span></a>.</p>
</section>
...
<div class="prev-next-area">
    <a class="left-prev"
       href="../what-is-hipsparselt.html"
       title="previous page">
      <i class="fa-solid fa-angle-left"></i>
      <div class="prev-next-info">
        <p class="prev-next-subtitle">previous</p>
        <p class="prev-next-title">What is hipSPARSELt?</p>
      </div>
    </a>
    <a class="right-next"
       href="install-hipsparselt.html"
       title="next page">
      <div class="prev-next-info">
        <p class="prev-next-subtitle">next</p>
        <p class="prev-next-title">Installing and building hipSPARSELt</p>
      </div>
