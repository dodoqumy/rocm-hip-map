---
title: "MIVisionX sample applications &#8212; MIVisionX 3.5.0 Documentation"
source_url: "https://rocm.docs.amd.com/projects/MIVisionX/en/latest/tutorials/MIVisionX-apps-samples.html"
source_type: official
source_org: amd
credibility: 5
lifecycle: latest
fetched_at: 2026-05-02T21:11:12.333360+00:00
content_hash: "c195e87ea68b89d8"
---
...
<meta content="MIVisionX, ROCm, applications, samples" name="keywords" />
    ...
    <title>MIVisionX sample applications &#8212; MIVisionX 3.5.0 Documentation</title>
...
<link rel="preload" as="script" href="../_static/scripts/pydata-sphinx-theme.js?digest=8878045cc6db502f8baf" />
    ...
    <script>DOCUMENTATION_OPTIONS.pagename = 'tutorials/MIVisionX-apps-samples';</script>
    <script async="async" src="https://download.amd.com/js/analytics/analyticsinit.js"></script>
    <link rel="icon" href="https://www.amd.com/content/dam/code/images/favicon/favicon.ico"/>
    <link rel="index" title="Index" href="../genindex.html" />
    <link rel="search" title="Search" href="../search.html" />
    <link rel="next" title="MIVisionX model compiler samples" href="MIVisionX-model-comp-samples.html" />
    <link rel="prev" title="MIVisionX APIs" href="../doxygen/html/modules.html" />
    <meta name="google-site-verification" content="vo35SZt_GASsTHAEmdww7AYKPCvZyzLvOXBl8guBME4" />

  <script async type="text/javascript" src="/_/static/javascript/readthedocs-addons.js"></script><meta name="readthedocs-project-slug" content="advanced-micro-devices-mivisionx" /><meta name="readthedocs-version-slug" content="latest" /><meta name="readthedocs-resolver-filename" content="/tutorials/MIVisionX-apps-samples.html" /><meta name="readthedocs-http-status" content="200" /></head>
...
<li class="toctree-l1 current active"><a class="current reference internal" href="#">Sample applications</a></li>
<li class="toctree-l1"><a class="reference internal" href="MIVisionX-model-comp-samples.html">Model compiler samples</a></li>
</ul>
...
<nav aria-label="Breadcrumb" class="d-print-none">
  <ul class="bd-breadcrumbs">
    ...
    <li class="breadcrumb-item active" aria-current="page"><span class="ellipsis">MIVisionX sample applications</span></li>
  </ul>
</nav>
</div>
...
<div id="jb-print-docs-body" class="onlyprint">
    <h1>MIVisionX sample applications</h1>
    <!-- Table of contents -->
...
<div id="searchbox"></div>
  ...
  <section id="mivisionx-sample-applications">
<h1>MIVisionX sample applications<a class="headerlink" href="#mivisionx-sample-applications" title="Link to this heading">#</a></h1>
<p>Several examples applications are available for use with MIVisionX.</p>
<p>The applications in the <a class="reference external" href="https://github.com/ROCm/MIVisionX/tree/develop/apps">apps directory</a> illustrate how the MIVisionX libraries can be used to develop products.</p>
<p>The samples in the <a class="reference external" href="https://github.com/ROCm/MIVisionX/tree/develop/samples">samples directory</a> can be used to learn how to use the MIVisionX libraries.</p>
<p>Utilities that can be used to develop, prototype, and test sample applications are available from the <a class="reference external" href="https://github.com/ROCm/MIVisionX/tree/develop/utilities">MIVisionX GitHub repository</a>:</p>
<ul class="simple">
<li><p><a class="reference external" href="https://github.com/ROCm/MIVisionX/tree/develop/utilities/mv_deploy">mv_deploy</a> is a utility that uses the model compiler to create and build applications.</p></li>
<li><p><a class="reference external" href="https://github.com/ROCm/MIVisionX/tree/develop/utilities/runvx">RunVX</a> is a command-line tool that runs OpenVX graphs.</p></li>
</ul>
</section>
...
<div class="prev-next-area">
    ...
    <a class="right-next"
       href="MIVisionX-model-comp-samples.html"
       title="next page">
      <div class="prev-next-info">
        <p class="prev-next-subtitle">next</p>
        <p class="prev-next-title">MIVisionX model compiler samples</p>
      </div>
