...
source_url: "https://rocm.docs.amd.com/en/docs-7.2.0/reference/gpu-arch-specs.html"
source_type: official
source_org: amd
credibility: 5
lifecycle: latest
fetched_at: 2026-05-01T12:04:19.228152+00:00
content_hash: "c86089872ba5d2ee"
---
...
[Understanding the HIP programming model](https://rocm.docs.amd.com/projects/HIP/en/docs-7.2.0/understand/programming_model.html).

**LLVM target name**

Argument to pass to clang in `--offload-arch`

to compile code for the given
architecture.
