...
credibility: 5
lifecycle: latest
fetched_at: 2026-05-03T06:16:22.562238+00:00
content_hash: "5b35a1ed33e0a96a"
---
...
[PyTorch installation guide](https://rocm.docs.amd.com/projects/install-on-linux/en/latest/install/3rd-party/pytorch-install.html). For a consistent installation, it’s recommended to use official ROCm prebuilt Docker images with the framework pre-installed.In the Docker container, check the availability of ROCm-capable GPUs using the following command.
...
[Meta’s official Llama model](https://huggingface.co/meta-llama)from Hugging Face. After permission is granted, log in with the following command using your personal access tokens:auth login
