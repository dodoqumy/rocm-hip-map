---
title: "MIGraphX driver"
source_url: "https://rocm.docs.amd.com/projects/AMDMIGraphX/en/latest/migraphx-driver.html"
source_type: official
source_org: amd
credibility: 5
lifecycle: latest
fetched_at: 2026-05-04T15:24:48.363863+00:00
content_hash: "a511f50969cc38dd"
---
...
It is installed by default when you install MIGraphX. You can find it in `/opt/rocm/bin/migraphx-driver`

or in `AMDMIGraphX/build/bin/migraphx-driver`
...
The table below summarizes the various options to be used with the [MIGraphX driver commands](#driver-commands).
To learn which options can be used with which commands, see the [MIGraphX driver options](reference/driver-options.html#driver-options).
...
### Option: run (ONNX file input)[#](#option-run-onnx-file-input)
...
### Option: compile (on GPU, quantized for fp16)[#](#option-compile-on-gpu-quantized-for-fp16)
