...
source_url: "https://rocm.docs.amd.com/en/docs-7.2.0/how-to/rocm-for-ai/inference-optimization/workload.html"
source_type: official
source_org: amd
credibility: 5
lifecycle: latest
fetched_at: 2026-05-02T15:03:03.462247+00:00
content_hash: "7db4992c668e4494"
---
...
[model inference](vllm-optimization.html#mi300x-vllm-optimization), offering strategies to
enhance efficiency.

The following topics highlight [auto-tunable configurations](#mi300x-auto-tune) as
well as [Triton kernel optimization](#mi300x-triton-kernel-performance-optimization)
...
[Triton’s auto-tuning features](#mi300x-autotunable-kernel-config)to explore various kernel configurations and select the best-performing ones.
...
For more information, see [vLLM inference](../inference/benchmark-docker/vllm.html).
...
[ROCProfiler](https://rocm.docs.amd.com/projects/rocprofiler/en/docs-7.2.0/index.html)documentation.ROCm Compute Profiler builds upon ROCProfiler but provides more guided analysis. For more information, see

[ROCm Compute Profiler documentation](https://rocm.docs.amd.com/projects/rocprofiler-compute/en/docs-7.2.0/index.html).
...
[ROCProfiler](https://rocm.docs.amd.com/projects/rocprofiler/en/docs-7.2.0/index.html) is primarily a low-level API for accessing and extracting GPU hardware performance
...
utility also depends on the [ROCTracer and ROC-TX libraries](https://rocm.docs.amd.com/projects/roctracer/en/docs-7.2.0/index.html), giving it the
...
[ROCm Compute Profiler](https://rocm.docs.amd.com/projects/rocprofiler-compute/en/docs-7.2.0/index.html) is a system performance profiler for high-performance computing (HPC) and
...
[ROCm Systems Profiler](https://rocm.docs.amd.com/projects/rocprofiler-systems/en/docs-7.2.0/index.html) is a comprehensive profiling and tracing tool for parallel applications,
...
performance and ease of use. See [vLLM V1 performance optimization](vllm-optimization.html), where you’ll learn
how to:
...
[hipBLASLt](https://rocm.docs.amd.com/projects/hipBLASLt/en/docs-7.2.0/index.html) has a backend assembly generator in
...
What does [PerfDb](https://rocm.docs.amd.com/projects/MIOpen/en/docs-7.2.0/conceptual/perfdb.html) look like?
...
See [Using the performance database](https://rocm.docs.amd.com/projects/MIOpen/en/docs-7.2.0/conceptual/perfdb.html) for more information.
...
What does [FindDb](https://rocm.docs.amd.com/projects/MIOpen/en/docs-7.2.0/conceptual/finddb.html) look like?
...
See [Using the find APIs and immediate mode](https://rocm.docs.amd.com/projects/MIOpen/en/docs-7.2.0/how-to/find-and-immediate.html) for more information.
...
[RCCL](https://rocm.docs.amd.com/projects/rccl/en/docs-7.2.0/index.html) is a stand-alone library of standard collective
...
[Occupancy related to VGPR usage in an Instinct MI300X GPU](#mi300x-occupancy-vgpr-table).
...
[Performance guidelines](https://rocm.docs.amd.com/projects/HIP/en/docs-7.2.0/how-to/performance_guidelines.html) section of the
HIP documentation.
...
See [HIP’s performance guidelines](https://rocm.docs.amd.com/projects/HIP/en/docs-7.2.0/how-to/performance_guidelines.html) for
greater detail.
...
[ROCr Debug Agent documentation](https://rocm.docs.amd.com/projects/rocr_debug_agent/en/docs-7.2.0/index.html).
