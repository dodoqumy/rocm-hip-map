...
source_url: "https://rocm.docs.amd.com/en/docs-7.2.0/how-to/rocm-for-ai/training/benchmark-docker/primus-megatron.html"
source_type: official
source_org: amd
credibility: 5
lifecycle: latest
fetched_at: 2026-05-02T18:02:21.551869+00:00
content_hash: "a40d700038a210aa"
---
...
[Migrating workloads to Primus (Megatron backend) from Megatron-LM](previous-versions/megatron-lm-primus-migration-guide.html).
...
run -it \ --device /dev/dri \ --device /dev/kfd \ --device /dev/infiniband \ --network host --ipc host \ --group-add video \ --cap-add SYS_PTRACE \ --security-opt seccomp=unconfined \ --privileged \ -v $HOME:$HOME \ --shm-size 128G \ --name primus_training_env \ rocm/primus:v26.1
...
The Docker container hosts verified commit `9c529cd4`
...
[examples/megatron/configs](https://github.com/AMD-AGI/Primus/tree/9c529cd4a934a68a880ede036c3e97b792e38167/examples/megatron/configs).
...
[key options](previous-versions/primus-megatron-v25.8.html#amd-primus-megatron-lm-benchmark-test-vars), and run training on
...
See [Supported models](#amd-primus-megatron-lm-model-support-v26-01) to switch to another available model.
...
[run_slurm_pretrain.sh](https://github.com/AMD-AGI/Primus/blob/9c529cd4a934a68a880ede036c3e97b792e38167/examples/run_slurm_pretrain.sh)
...
(see[Tokenizer](#amd-primus-megatron-lm-tokenizer-v26-01)) as appropriate.
