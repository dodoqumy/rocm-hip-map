---
title: "AMD Instinct MI200 system optimization"
source_url: "https://rocm.docs.amd.com/en/docs-6.2.0/how-to/system-optimization/mi200.html"
source_type: official
source_org: amd
credibility: 5
lifecycle: latest
fetched_at: 2026-05-04T16:23:27.480941+00:00
content_hash: "875db63643a238f9"
---

# AMD Instinct MI200 system optimization[#](#amd-instinct-mi200-system-optimization)
...
Configure the system BIOS settings as explained in [System BIOS settings](#mi200-bios-settings) and
enact the below given settings via the command line as explained in
[Operating system settings](#mi200-os-settings):
...
[Quick-start (Linux)](https://rocm.docs.amd.com/projects/install-on-linux/en/docs-6.2.0/install/quick-start.html). For verifying that the
installation was successful, refer to the
[post-install instructions](https://rocm.docs.amd.com/projects/install-on-linux/en/docs-6.2.0/install/post-install.html) and
[system tools](../../reference/rocm-tools.html). Should verification
...
[Linux](https://rocm.docs.amd.com/projects/install-on-linux/en/docs-6.2.0/reference/system-requirements.html) and
Windows.

### Testing inter-device bandwidth[#](#testing-inter-device-bandwidth)

[Hardware verification with ROCm](mi100.html#mi100-hw-verification) showed the `rocm-smi --showtopo`
