...
source_url: "https://rocm.docs.amd.com/en/latest/how-to/rocm-for-ai/training/benchmark-docker/previous-versions/pytorch-training-v25.7.html"
...
The [PyTorch for ROCm training Docker](https://hub.docker.com/layers/rocm/pytorch-training/v25.7/images/sha256-cc6fd840ab89cb81d926fc29eca6d075aee9875a55a522675a4b9231c9a0a712){.reference .external} ([`rocm/pytorch-training:v25.7`{.docutils .literal .notranslate}]{.pre}) image provides a prebuilt optimized environment for fine-tuning and pretraining a model on AMD Instinct MI325X and MI300X GPUs. It includes the following software components to accelerate training workloads:
...
[]{#amd-pytorch-training-model-support-v257}
...
::: {.col-3 .px-2 .model-param param-k="model-group" param-v="openai" tabindex="0"}
OpenAI
:::
...
::: {.col-3 .px-2 .model-param param-k="model-group" param-v="flux" tabindex="0"}
Flux
:::
:::::::
:::::::::
...
[]{#amd-pytorch-training-performance-measurements-v257}
...
2.  Run the setup script to install libraries and datasets needed for benchmarking.
    ...
    ::: pst-scrollable-table-container
      ...
      ---------------------------------------------------------- -----------------------------------------------------------------------------------------------------------
      [`datasets`{.docutils .literal .notranslate}]{.pre}        [Hugging Face Datasets](https://huggingface.co/docs/datasets/v3.2.0/en/index){.reference .external} 3.2.0
      [`torchdata`{.docutils .literal .notranslate}]{.pre}       [TorchData](https://pytorch.org/data/beta/index.html){.reference .external}
...
To start the fine-tuning benchmark, use the following command with the appropriate options. See the following list of options and their descriptions. See [[supported training modes]{.std .std-ref}](#amd-pytorch-training-supported-training-modes-v257){.reference .internal}.
...
Currently, FLUX models are not supported out-of-the-box on rocm/pytorch-training:v25.7. To use FLUX, refer to the previous version of the [`pytorch-training`{.docutils .literal .notranslate}]{.pre} Docker: [[Training a model with PyTorch for ROCm]{.doc}](pytorch-training-v25.6.html){.reference .internal}
