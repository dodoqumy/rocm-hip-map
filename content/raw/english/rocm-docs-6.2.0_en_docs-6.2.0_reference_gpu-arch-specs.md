...
source_url: "https://rocm.docs.amd.com/en/docs-6.2.0/reference/gpu-arch-specs.html"
source_type: official
source_org: amd
credibility: 5
lifecycle: latest
fetched_at: 2026-05-04T16:17:28.858565+00:00
content_hash: "6197eb2ee69b71a1"
---

# Accelerator and GPU hardware specifications[#](#accelerator-and-gpu-hardware-specifications)
...
[specific documents and guides](../conceptual/gpu-arch.html#gpu-arch-documentation), or
[Understanding the HIP programming model](https://rocm.docs.amd.com/projects/HIP/en/docs-6.2.0/understand/programming_model.html).
...
Size of the level 3 cache. Shared by all compute units on the same GCD. Caches data and instructions.

**Graphics L1 Cache (RDNA only)**

An additional cache level that only exists in RDNA architectures. Local to a work group processor.
