---
title: "hipSPARSELt: Data Structures &#8212; hipSPARSELt 0.2.6 Documentation"
source_url: "https://rocm.docs.amd.com/projects/hipSPARSELt/en/latest/doxygen/html/annotated.html"
source_type: official
source_org: amd
credibility: 5
lifecycle: latest
fetched_at: 2026-05-02T15:10:41.319501+00:00
content_hash: "64bfdbde8f4c9327"
---
...
<html lang="en" data-content_root="../../" >
  ...
  <head>
    ...
    <title>hipSPARSELt: Data Structures &#8212; hipSPARSELt 0.2.6 Documentation</title>
...
<nav aria-label="Breadcrumb" class="d-print-none">
  <ul class="bd-breadcrumbs">
    ...
    <li class="breadcrumb-item active" aria-current="page"><span class="ellipsis">hipSPARSELt: Data Structures</span></li>
  </ul>
</nav>
</div>
...
<title>hipSPARSELt: Data Structures</title>
...
<tr id="row_0_" class="even"><td class="entry"><span style="width:16px;display:inline-block;">&#160;</span><span class="icona"><span class="icon">C</span></span><a class="el" href="structhipsparse_lt_handle__t.html" target="_self">hipsparseLtHandle_t</a></td><td class="desc">Handle to the hipSPARSELt library context queue </td></tr>
<tr id="row_1_"><td class="entry"><span style="width:16px;display:inline-block;">&#160;</span><span class="icona"><span class="icon">C</span></span><a class="el" href="structhipsparse_lt_mat_descriptor__t.html" target="_self">hipsparseLtMatDescriptor_t</a></td><td class="desc">Descriptor of the matrix </td></tr>
<tr id="row_2_" class="even"><td class="entry"><span style="width:16px;display:inline-block;">&#160;</span><span class="icona"><span class="icon">C</span></span><a class="el" href="structhipsparse_lt_matmul_alg_selection__t.html" target="_self">hipsparseLtMatmulAlgSelection_t</a></td><td class="desc">Descriptor of the matrix multiplication algorithm </td></tr>
<tr id="row_3_"><td class="entry"><span style="width:16px;display:inline-block;">&#160;</span><span class="icona"><span class="icon">C</span></span><a class="el" href="structhipsparse_lt_matmul_descriptor__t.html" target="_self">hipsparseLtMatmulDescriptor_t</a></td><td class="desc">Descriptor of the matrix multiplication operation </td></tr>
<tr id="row_4_" class="even"><td class="entry"><span style="width:16px;display:inline-block;">&#160;</span><span class="icona"><span class="icon">C</span></span><a class="el" href="structhipsparse_lt_matmul_plan__t.html" target="_self">hipsparseLtMatmulPlan_t</a></td><td class="desc">Descriptor of the matrix multiplication execution plan </td></tr>
</table>
</div><!-- directory -->
</div><!-- contents -->
