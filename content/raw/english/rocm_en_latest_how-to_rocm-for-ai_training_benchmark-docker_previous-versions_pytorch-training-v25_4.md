...
- [Environment setup](#environment-setup){.reference .internal .nav-link}
  ...
  - [Prepare training datasets and dependencies](#prepare-training-datasets-and-dependencies){.reference .internal .nav-link}
- [Getting started](#getting-started){.reference .internal .nav-link}
  - [Pretraining](#pretraining){.reference .internal .nav-link}
...
[]{#amd-pytorch-training-model-support-v254}
...
[]{#amd-pytorch-training-performance-measurements-v254}
...
4.  In the Docker container, clone the [ROCm/MAD](https://github.com/ROCm/MAD){.github .reference .external} repository and navigate to the benchmark scripts directory [`/workspace/MAD/scripts/pytorch_train`{.docutils .literal .notranslate}]{.pre}.
...
::: pst-scrollable-table-container
  ...
  [`$model_repo`{.docutils .literal .notranslate}]{.pre}        [`Llama-3.1-8B`{.docutils .literal .notranslate}]{.pre}                                             [Llama 3.1 8B](https://huggingface.co/meta-llama/Llama-3.1-8B-Instruct){.reference .external}
